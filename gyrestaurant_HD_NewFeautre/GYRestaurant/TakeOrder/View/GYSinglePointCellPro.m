...
@interface GYSinglePointCellPro()
...
@implementation GYSinglePointCellPro
...
- (void)setSfModel:(id)sfModel
{
    ...
    if ([sfModel isKindOfClass:[GYSyncShopFoodsModel class]]) {
        ...
        self.lbPrice.text = [NSString stringWithFormat:@"%.2f",fm.foodPv.doubleValue];
        self.lbIntegral.text = [NSString stringWithFormat:@"%.2f",fm.foodPrice.doubleValue];
