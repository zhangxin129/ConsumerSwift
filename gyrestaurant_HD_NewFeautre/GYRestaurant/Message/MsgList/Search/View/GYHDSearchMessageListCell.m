...
-(void)refreshWithGYHDSearchCompanyMessageModel:(GYHDSearchCompanyMessageModel *)model{
    ...
    if ([model.msgIcon hasPrefix:@"http"]) {
        ...
        [_iconImage setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",globalData.loginModel.picUrl,model.msgIcon]] placeholder:[UIImage imageNamed:@"defaultheadimg"] options:kNilOptions completion:nil];
    }
