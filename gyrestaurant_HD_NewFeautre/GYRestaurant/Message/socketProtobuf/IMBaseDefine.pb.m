...
- (BOOL) isEqual:(id)other {
  ...
  return
      ...
      self.hasStrinfo == otherMessage.hasStrinfo &&
      (!self.hasStrinfo || [self.strinfo isEqual:otherMessage.strinfo]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  __block NSUInteger hashCode = 7;
...
- (BOOL) isEqual:(id)other {
  ...
  return
      ...
      (!self.hasServerip || [self.serverip isEqual:otherMessage.serverip]) &&
...
- (BOOL) isEqual:(id)other {
  ...
  return
      self.hasErrinfo == otherMessage.hasErrinfo &&
      (!self.hasErrinfo || [self.errinfo isEqual:otherMessage.errinfo]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  __block NSUInteger hashCode = 7;
...
- (ClientRegRspBuilder*) mergeErrinfo:(ErrorInfo*) value {
  if (resultClientRegRsp.hasErrinfo &&
