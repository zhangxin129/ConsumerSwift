...
- (void)setup
{
    ...
    [rephotographButton setBackgroundImage:[UIImage imageNamed:@"HD_rephotograph_select"] forState:UIControlStateNormal];
    [rephotographButton setBackgroundImage:[UIImage imageNamed:@"HD_rephotograph_unselect"] forState:UIControlStateHighlighted];
    ...
    [sendButton setBackgroundImage:[UIImage imageNamed:@"camera_qd_n"] forState:UIControlStateNormal];
    [sendButton setBackgroundImage:[UIImage imageNamed:@"camera_qd_h"] forState:UIControlStateHighlighted];
