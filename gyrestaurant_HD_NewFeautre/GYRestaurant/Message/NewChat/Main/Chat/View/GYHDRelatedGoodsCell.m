...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self.goodsPriceButton setImage:[UIImage imageNamed:@"HD_HSB"] forState:UIControlStateNormal];
        ...
        [self.goodsPVButton setImage:[UIImage imageNamed:@"HD_PV"] forState:UIControlStateNormal];
        ...
        [self.goodsPVButton mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(weakSelf.goodsPriceButton.mas_right).offset(40);
...
- (void)setModel:(GYHDNewChatModel *)model {
    _model = model;
    NSDictionary *goodsDict = [Utils stringToDictionary:model.chatBody];
    [self.goodsImageView setImageWithURL:[NSURL URLWithString:goodsDict[@"imageNailsUrl"]] placeholder:[UIImage imageNamed:@"ep_placeholder_image_type1"]];
