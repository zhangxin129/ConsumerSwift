...
- (void)setChatModel:(GYHDNewChatModel *)chatModel
{
    ...
    [self.chatPictureImageView setImageWithURL:[NSURL URLWithString:bodyDict[@"msg_imageNail"]] placeholder:[UIImage imageNamed:@"ep_placeholder_image_type1"] options:kNilOptions completion:^(UIImage * _Nullable image, NSURL * _Nonnull url, YYWebImageFromType from, YYWebImageStage stage, NSError * _Nullable error) {
