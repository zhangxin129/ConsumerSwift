...
- (void)setup
{
    [self setBackgroundImage:[UIImage imageNamed:@"blueBox.png"] forState:UIControlStateNormal];
    [self setTitle:kLocalized(@"PleaseSelect") forState:UIControlStateNormal];
    ...
    imgInvertedTriangle.image = [UIImage imageNamed:@"invertedTriangle.png"];
