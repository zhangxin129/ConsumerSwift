...
//    cButton.font = [UIFont systemFontOfSize:15];
    ...
    [cButton setTitleColor:[UIColor redColor] forState:UIControlStateDisabled];
    [cButton setTitleColor:[UIColor colorWithRed:70/255.0 green:70/255.0 blue:70/255.0 alpha:1] forState:UIControlStateNormal];
    ...
    if (showSeparator && index > 0) {
        ...
        UIView *vSeparator = [[UIView alloc] initWithFrame:CGRectMake(cButton.frame.origin.x - kSeparatorWidth,
                                                                      ...
                                                                      kSeparatorWidth,
                                                                      vSeparatorH)];
        [vSeparator setBackgroundColor:[UIColor colorWithRed:230/255.0 green:230/255.0 blue:230/255.0 alpha:1]];
...
//                                               CGRectGetMaxY(self.frame),
        ...
        if (!underLineView) {
            ...
            [underLineView setBackgroundColor:[UIColor redColor]];
        ...
        [ivBottomLine setBackgroundColor:[UIColor colorWithRed:180/255.0 green:180/255.0 blue:180/255.0 alpha:1]];
...
- (void)updateMenu:(NSInteger)index {
    ...
    if ([self.delegate respondsToSelector:@selector(menuTabViewDidSelectIndex:)]) {
        cButton.enabled = YES;
        [cButton setTitleColor:[UIColor redColor] forState:UIControlStateSelected];
