...
static const void* UIViewLineWidthKey = &UIViewLineWidthKey;
@implementation UIView (Extension)

- (void)setCustomBorderLineWidth:(NSNumber *)customBorderLineWidth
{
    if (customBorderLineWidth) {
        objc_setAssociatedObject(self, @selector(customBorderLineWidth), customBorderLineWidth, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
