...
{
    GYAlertView* alert = [[GYAlertView alloc] initWithTitle:(NSString*)title Message:message topColor:topColor comfirmBlock:block];
    [alert show];
   
}

- (instancetype)initWithTitle:(NSString*)title Message:(NSString*)message topColor:(TopColor)topColor comfirmBlock:(dispatch_block_t)block
{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        [self setUpViewWithTitle:title Message:message topColor:topColor];
    }
    return self;
}

- (void)setUpViewWithTitle:(NSString*)title Message:(NSString*)message topColor:(TopColor)topColor
{
    ...
    titleLabel.text = title.length > 0 ? title : kLocalized(@"温馨提示");
