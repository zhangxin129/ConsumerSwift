...
#import "GYPopUpView.h"
#import "GYProgressPopUpView.h"

@interface GYProgressPopUpView () <ASPopUpViewDelegate>
@property (strong, nonatomic) NSNumberFormatter* numberFormatter;
@property (strong, nonatomic) GYPopUpView* popUpView;
@end

@implementation GYProgressPopUpView {
...
- (void)setDataSource:(id<GYProgressPopUpViewDataSource>)dataSource
{
...
- (void)setup
{
    ...
    self.popUpView = [[GYPopUpView alloc] initWithFrame:CGRectZero];
...
- (void)updatePopUpView
{
    ...
    if (progressString.length == 0)
        progressString = @"???"; // replacement for blank string
