...
@protocol GYProgressPopUpViewDelegate;
@protocol GYProgressPopUpViewDataSource;

@interface GYProgressPopUpView : UIProgressView
...
@property (weak, nonatomic) id<GYProgressPopUpViewDataSource> dataSource;

// delegate is only needed when used with a TableView or CollectionView - see below
@property (weak, nonatomic) id<GYProgressPopUpViewDelegate> delegate;
@end
...
@protocol GYProgressPopUpViewDataSource <NSObject>
- (NSString*)progressView:(GYProgressPopUpView*)progressView stringForProgress:(float)progress;
...
- (BOOL)progressViewShouldPreCalculatePopUpViewSize:(GYProgressPopUpView*)progressView;
@end
...
@protocol GYProgressPopUpViewDelegate <NSObject>
- (void)progressViewWillDisplayPopUpView:(GYProgressPopUpView*)progressView;

@optional
- (void)progressViewDidHidePopUpView:(GYProgressPopUpView*)progressView;
@end
