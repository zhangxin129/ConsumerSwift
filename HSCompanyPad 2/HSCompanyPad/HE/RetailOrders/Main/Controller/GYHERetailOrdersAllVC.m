...
@interface GYHERetailOrdersAllVC () <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate,UIGestureRecognizerDelegate>
...
@implementation GYHERetailOrdersAllVC
