//
//  GYSettingSafeSetPiecewiseView.h
//  HSCompanyPad
//
...
@class GYSettingSafeSetPiecewiseView;
...
@end
@interface GYSettingSafeSetPiecewiseView : UIView
...
@property (assign, nonatomic) id<PiecewiseViewDelegate> delegate;
