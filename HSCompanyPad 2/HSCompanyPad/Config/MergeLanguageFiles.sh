...
language_file="${SRCROOT}/HSCompanyPad/Resource/${language}.lproj/Localizable.strings"
...
do
    ...
    language_file="${SRCROOT}/HSCompanyPad/Resource/${lang}.lproj/Localizable.strings"
