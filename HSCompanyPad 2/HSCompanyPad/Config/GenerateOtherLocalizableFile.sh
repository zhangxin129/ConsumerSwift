...
function process_lang ($lang)
{
    ...
    $strings_file = $src_root . '/HSCompanyPad/Resource/' .$lang. '.lproj/Localizable.strings';
...
$src_root = $args['d'];
$og_strings_file = $src_root . '/HSCompanyPad/Resource/zh-Hans.lproj/Localizable.strings';
