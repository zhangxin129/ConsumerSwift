...
{
    GYAlertView* alertView = [[GYAlertView alloc] initWithMessage:message cancleButtonTitle:nil confirmButtonTitle:confirmBtnTitle cancleBlock:nil confirmBlock:nil color:buttonColor];
    [alertView show];
    return alertView;
}
...
{
    GYAlertView* alertView = [[GYAlertView alloc] initWithMessage:message cancleButtonTitle:nil confirmButtonTitle:confirmBtnTitle cancleBlock:nil confirmBlock:confirmBlock color:buttonColor];
    [alertView show];
    return alertView;
}
...
{
    GYAlertView* alertView = [[GYAlertView alloc] initWithMessage:message cancleButtonTitle:cancleBtnTitle confirmButtonTitle:confirmBtnTitle cancleBlock:cancleBlock confirmBlock:confirmBlock color:buttonColor];
    [alertView show];
    return alertView;
}
...
{
    GYAlertView* alertView = [[GYAlertView alloc] initWithAttributedMessage:message cancleButtonTitle:nil confirmButtonTitle:confirmBtnTitle cancleBlock:nil confirmBlock:confirmBlock color:buttonColor];
    [alertView show];
    return alertView;
}
...
//    }
    ...
    UIView* lineView = [[UIView alloc] initWithFrame:CGRectMake(0, alertViewHeight * 0.7, alertViewWidth, 1.0f)];
    lineView.backgroundColor = kDefaultViewBorderColor;
    [self addSubview:lineView];
