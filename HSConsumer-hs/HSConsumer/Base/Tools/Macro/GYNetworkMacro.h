...
// 获取服务器的URL
#define kgetTimeBaseURL [[GYHSLoginEn sharedInstance] getTimeUrl]
...
//历年回报率
#define kYearDividendRateListUrlString [HSReconsitutionUrl stringByAppendingString:@"/invest/getDividendRateList"]
...
//新增用户收货地址
#define kGetDefaultAddUserAddressUrlString [newRetailDomainBase stringByAppendingString:@"/addressManagementController/addUserAddress"]
...
// 获取服务器时间
#define kGetServerTimeString [HSReconsitutionUrl stringByAppendingString:@"/common/getServerTime"]
...
#define kGetTimeURL [kgetTimeBaseURL stringByAppendingString:@"/getTime"]

//新电商域名
#define newRetailDomainBase @"http://192.168.229.17:8085"
#pragma mark --电商改版新增接口
//------------------接口-------------------------
//查询网上商城信息
#define kGetSalerVirtualShopsUrl [newRetailDomainBase stringByAppendingString:@"/shopController/getVShopInfo"]
#define kGetShopDetailListUrl [newRetailDomainBase stringByAppendingString:@"/itemController/findItems"]
#define kCollectShopNewUrl [newRetailDomainBase stringByAppendingString:@"/followShopController/saveFavoriteShop"]
#define kDeleteCollectShopNewUrl [newRetailDomainBase stringByAppendingString:@"/followShopController/deleteFavoriteShops"]


//查询商品详情
#define kgetDetailByIdUrl [newRetailDomainBase stringByAppendingString:@"/itemController/findItemDetail"]
//加入购车车
#define kAddItemsToCartUrl [newRetailDomainBase stringByAppendingString:@"/cartController/addItemsToCart"]

//收藏商品
#define kSaveFavoriteItem [newRetailDomainBase stringByAppendingString:@"/followShopController/saveFavoriteItem"]
//取消收藏商品
#define kDeleteFavoriteItems [newRetailDomainBase stringByAppendingString:@"/followShopController/deleteFavoriteItems"]




//获取用户收藏的商品列表
#define kgetFavoriteItemListUrl [newRetailDomainBase stringByAppendingString:@"/followShopController/getFavoriteItemList"]


//3.4.6.1 获取用户收藏的商城列表
#define kgetFavoriteShopListUrl [newRetailDomainBase stringByAppendingString:@"/followShopController/getFavoriteShopList"]

//3.5.1 生成移动区域文件
#define kgetMobileAreaFileUrl [newRetailDomainBase stringByAppendingString:@"/areaAndLocation/getMobileAreaFile"]

//周边逛商铺列表
#define kgetSurroundVisitShopListUrl [newRetailDomainBase stringByAppendingString:@"/shopController/searchShopList"]

//4.1 搜索商城列表
#define kshopControllerFindVShopsUrl [newRetailDomainBase stringByAppendingString:@"/shopController/findVShops"]

//3.2 生成移动商圈文件
#define kgetMobileLocationFileUrl [newRetailDomainBase stringByAppendingString:@"/areaAndLocation/getMobileLocationFile"]

//8.2 查询用户的商城浏览记录
#define kfindBrowseVshopListUrl [newRetailDomainBase stringByAppendingString:@"/userBrowseController/findBrowseVshopList"]

//8.4 查询用户的商品浏览记录
#define kfindBrowseItemListUrl [newRetailDomainBase stringByAppendingString:@"/userBrowseController/findBrowseItemList"]


//9.1 获取用户收货地址
#define kFindAhippingAddressUrl [newRetailDomainBase stringByAppendingString:@"/addressManagementController/findAhippingAddress"]

//7.1 获取购物车项目列表
#define kCartFindCartListUrl [newRetailDomainBase stringByAppendingString:@"/cartController/findCartList"]

//7.3 添加或减少购物车已有商品的数量
#define kCartAddOrCutItemNumInCart [newRetailDomainBase stringByAppendingString:@"/cartController/addOrCutItemNumInCart"]
