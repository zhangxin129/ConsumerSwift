...
@protocol GYHDTagViewDelegate <NSObject>
...
typedef enum {
    // 编辑状态
    GYHDTagView_Type_Edit,
    // 展示状态
    GYHDTagView_Type_Display,
    // 选中状态
    GYHDTagView_Type_Selected
    
} GYHDTagView_Type;

@interface GYHDTagView : UIView

@property (nonatomic, strong) id <GYHDTagViewDelegate> delegate;
/**
...
/**
 *  默认是编辑模式(GYHDTagView_Type_Edit)
 */
@property (nonatomic) GYHDTagView_Type type;
/**
 *  默认的标签宽度
 */
