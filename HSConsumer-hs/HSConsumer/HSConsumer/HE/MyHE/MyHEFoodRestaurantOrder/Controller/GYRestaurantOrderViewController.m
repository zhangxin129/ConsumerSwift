...
- (void)createMyTableView
{
    _mytable = ({
        ...
        tab.delegate = self;
        tab.dataSource = self;
        [tab registerNib:[UINib nibWithNibName:NSStringFromClass([GYRecstaurantTableViewCell class]) bundle:kDefaultBundle] forCellReuseIdentifier:orderCell];
        [tab registerNib:[UINib nibWithNibName:NSStringFromClass([GYRecestaurantOutCell class]) bundle:kDefaultBundle] forCellReuseIdentifier:orderOutCell];
