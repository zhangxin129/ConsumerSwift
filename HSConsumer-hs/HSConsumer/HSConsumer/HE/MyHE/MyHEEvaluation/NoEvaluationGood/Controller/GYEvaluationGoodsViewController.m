...
- (void)makeEvalutation:(UIButton*)sender
{
    ...
    GYMakeEvaluationViewController* vcMakeEvaluation = [[GYMakeEvaluationViewController alloc] initWithNibName:NSStringFromClass([GYMakeEvaluationViewController class]) bundle:nil];
