...
- (void)setupMainScrollView
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYEasybuyGoodsInfoTableViewCell class]) bundle:nil] forCellReuseIdentifier:GYEasybuyGoodsInfoTableViewCellReuseId];
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYEasybuyGoodsInfoItemTableViewCell class]) bundle:nil] forCellReuseIdentifier:GYEasybuyGoodsInfoItemTableViewCellReuseId];
...
- (GYEasybuyGoodsInfoPropView *)popView {
    if(!_popView) {
        _popView = [[NSBundle mainBundle] loadNibNamed:NSStringFromClass([GYEasybuyGoodsInfoPropView class]) owner:self options:0][0];
        [self setupPropHeaderView];
        [_popView.propTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYEasybuyGoodsInfoPropListTableViewCell class])  bundle:nil] forCellReuseIdentifier:GYEasybuyGoodsInfoPropListTableViewCellReuseId];
        [_popView.propTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYEasybuyGoodsInfoPropBuyNumTableViewCell class]) bundle:nil] forCellReuseIdentifier:GYEasybuyGoodsInfoPropBuyNumTableViewCellReuseId];
