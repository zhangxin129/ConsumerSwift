//
//  GYEasybuySearchMainController.m
...
@interface GYEasybuySearchMainController () <UITextFieldDelegate, UITableViewDataSource, UITableViewDelegate>
...
@implementation GYEasybuySearchMainController
...
- (UIView*)titleView
{
    ...
    //    self.searchLabel = btnChooseType.titleLabel;
