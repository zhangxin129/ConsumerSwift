...
- (void)setTableView
{
    ...
    [_recomFoodDetailTableView registerNib:[UINib nibWithNibName:NSStringFromClass([FDRecomdFoodCell class]) bundle:nil] forCellReuseIdentifier:@"FDRecomdFoodCellId"];
