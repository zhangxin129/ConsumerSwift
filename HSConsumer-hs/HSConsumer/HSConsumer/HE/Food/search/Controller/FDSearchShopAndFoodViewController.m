...
- (UITableView*)tableViewSearch
{
    if (!_tableViewSearch) {
        ...
        [tableViewSearch registerNib:[UINib nibWithNibName:NSStringFromClass([FDTakeawayMainCell class]) bundle:nil] forCellReuseIdentifier:FDTakeawayMainCellId];
        [tableViewSearch registerNib:[UINib nibWithNibName:NSStringFromClass([FDSearchFoodsCell class]) bundle:nil] forCellReuseIdentifier:FDSearchFoodsCellId];
