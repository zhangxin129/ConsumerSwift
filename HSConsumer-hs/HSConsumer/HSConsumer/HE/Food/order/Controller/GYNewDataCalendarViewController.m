...
- (void)viewDidLoad
{
    ...
    [self.topDateCollectionView registerNib:[UINib nibWithNibName:NSStringFromClass([GYDateCollectionViewCell class]) bundle:[NSBundle mainBundle]] forCellWithReuseIdentifier:@"GYDateCollectionViewCell"];
    [self.TimesCollectionView registerNib:[UINib nibWithNibName:NSStringFromClass([GYTimeCollectionViewCell class]) bundle:[NSBundle mainBundle]] forCellWithReuseIdentifier:@"GYTimeCollectionViewCell"];
