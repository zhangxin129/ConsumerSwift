...
- (void)viewDidLoad
{
    ...
    [_tableView registerNib:[UINib nibWithNibName:NSStringFromClass([FDTakeawayMainCell class]) bundle:nil] forCellReuseIdentifier:FDTakeawayMainCellREUSEID];
...
- (void)setupScrollView
{
    ...
    for (int i = 0; i < _favDataSource.count; i++) {
        FDTakeawayMainCell* headerCell = [[[NSBundle mainBundle] loadNibNamed:NSStringFromClass([FDTakeawayMainCell class]) owner:self options:nil] lastObject];
