...
- (void)setShopTableVIew
{
    ...
    [_shopTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYShopIntegrationCell class]) bundle:nil] forCellReuseIdentifier:@"ShopIntergrationCellIdentify"];
    [_shopTableView registerClass:[GYShopADCell class] forCellReuseIdentifier:@"GYShopADCellIdentify"];
    [_shopTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYShopVisitCell class]) bundle:nil] forCellReuseIdentifier:@"GYShopVisitCellIdentify"];
