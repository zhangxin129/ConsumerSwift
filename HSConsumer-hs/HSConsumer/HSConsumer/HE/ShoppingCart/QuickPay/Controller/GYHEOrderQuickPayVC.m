...
- (void)netRequest:(GYNetRequest*)netRequest didFailureWithError:(NSError*)error
{
    ...
    if ([responseObject[@"retCode"] isEqualToNumber:@204]) {
        ...
        self.tipsView = [[[NSBundle mainBundle] loadNibNamed:NSStringFromClass([GYHSNOLinkQuickPayCardView class]) owner:self options:nil] lastObject];
...
- (UITableView*)tableView
{
    if (_tableView == nil) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHEOrderQuickPayInfoCell class]) bundle:nil]
            forCellReuseIdentifier:@"GYHEOrderQuickPayInfoCell_Identify"];

        [_tableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYBankTableViewCell class]) bundle:nil]
            forCellReuseIdentifier:@"GYBankTableViewCell_Identify"];

        [_tableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSRegisterTableCell class]) bundle:nil]
            forCellReuseIdentifier:@"GYHSRegisterTableCell_Identify"];

        [_tableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSVConfirmTableCell class]) bundle:nil]
