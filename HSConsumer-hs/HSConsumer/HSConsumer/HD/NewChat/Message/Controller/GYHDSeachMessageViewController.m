...
//    _searchTextField = searchTextField;
    ...
    self.searchTextField.placeholder = [GYUtils localizedStringWithKey:@"GYHD_Search_friend_message_company"];
    self.searchTextField.font = [UIFont systemFontOfSize:12.0f];
    self.searchTextField.frame = CGRectMake(0, 0, kScreenWidth - 120, 30);
    ...
    [rightButton addTarget:self action:@selector(rightSearchButtonClick:) forControlEvents:UIControlEventTouchUpInside];
