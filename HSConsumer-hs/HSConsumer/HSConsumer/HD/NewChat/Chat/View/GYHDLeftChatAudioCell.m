...
- (void)setup
{
    ...
    chatbackgroundView.image = [UIImage imageNamed:@"gyhd_chat_other_back"];
    ...
    for (int i = 1; i <= 3; i++) {
        [imageArray addObject:[UIImage imageNamed:[NSString stringWithFormat:@"gyhd_audio_left_%d", i]]];
    }
    UIImageView* chatAudioImageView = [[UIImageView alloc] init];
    chatAudioImageView.image = [UIImage imageNamed:@"gyhd_audio_left_3"];
    ...
    chatAudioReadyState.image = [UIImage imageNamed:@"gyhd_chat_unread_icon"];
