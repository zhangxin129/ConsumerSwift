...
- (void)setChatModel:(GYHDNewChatModel*)chatModel
{
    ...
    [self.chatPictureImageView setImageWithURL:[NSURL URLWithString:urlString] placeholder:[UIImage imageNamed:@"gycommon_image_placeholder"] options:kNilOptions completion:^(UIImage* _Nullable image, NSURL* _Nonnull url, YYWebImageFromType from, YYWebImageStage stage, NSError* _Nullable error) {
