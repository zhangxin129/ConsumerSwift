...
{
    [self.showImageView setImageWithURL:url placeholder:[UIImage imageNamed:@"gycommon_image_placeholder"] options:kNilOptions completion:nil];
}
- (void)disMiss
{
...
- (void)longTap:(UILongPressGestureRecognizer*)longTap
{
    if (longTap.state == UIGestureRecognizerStateBegan) {
        actionSheet = [[UIActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:[GYUtils localizedStringWithKey:@"GYHD_cancel"] destructiveButtonTitle:nil otherButtonTitles:[GYUtils localizedStringWithKey:@"GYHD_save"], nil];
...
//        [GYUtils makeToast:[GYUtils localizedStringWithKey:@"GYHD_save_success"]];
//        [GYUtils showMessage];
        [GYUtils showToast:[GYUtils localizedStringWithKey:@"GYHD_save_success"] duration:2.5f position:CSToastPositionBottom];
        DDLogInfo([GYUtils localizedStringWithKey:@"GYHD_save_success"]);
