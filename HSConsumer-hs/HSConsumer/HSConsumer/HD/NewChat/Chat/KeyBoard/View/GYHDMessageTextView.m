...
//        NSAttributedString* insertAttString = [[GYHDMessageCenter sharedInstance] attStringWithString:board.string imageFrame:CGRectMake(0, 0, KFontSizePX(32.0f), KFontSizePX(32.0f)) attributes:nil];
        NSMutableAttributedString *insertAttString = [[NSMutableAttributedString alloc] initWithString:board.string];
        [[GYHDMessageCenter sharedInstance] messageContentAttributedStringWithString:board.string AttrString:insertAttString];
