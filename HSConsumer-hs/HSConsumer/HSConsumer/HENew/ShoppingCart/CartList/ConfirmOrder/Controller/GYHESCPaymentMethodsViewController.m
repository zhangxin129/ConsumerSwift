...
- (void)viewDidLoad
{
    ...
    [self.tabView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHESCPaymentMethodTableViewCell class]) bundle:nil] forCellReuseIdentifier:kPaymentMethodCell];
