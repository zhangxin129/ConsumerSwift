...
- (void)viewDidLoad
{
    ...
    [self.tabView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHESCDistributionWayTableViewCell class]) bundle:nil] forCellReuseIdentifier:kDistributionWayCell];
