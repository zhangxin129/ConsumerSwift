...
- (void)viewDidLoad
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSBaseQueryCell class]) bundle:nil] forCellReuseIdentifier:@"GYHSBaseQueryCell"];
...
- (void)tableView:(UITableView*)tableView didSelectRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    case 1: {
        ...
        if ([globalData.loginModel.isAuthEmail isEqualToString:kAuthHad] || ![GYUtils checkStringInvalid:globalData.loginModel.email]) {
            GYQuitPhoneBandingViewController* vcEmail = [[GYQuitPhoneBandingViewController alloc] initWithNibName:NSStringFromClass([GYQuitPhoneBandingViewController class]) bundle:nil];
