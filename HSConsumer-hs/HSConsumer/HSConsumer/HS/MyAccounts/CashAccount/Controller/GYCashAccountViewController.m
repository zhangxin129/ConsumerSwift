...
- (void)viewDidLoad
{
    ...
    [self.cashAccountTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSCellTypeImagelabel class]) bundle:nil] forCellReuseIdentifier:@"kCellTypeImagelabel"];
    [self.cashAccountTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSCurrencyAccountCell class]) bundle:nil] forCellReuseIdentifier:@"kGYHSCurrencyAccountCell"];
