...
- (void)viewDidLoad
{
    ...
    [self.cashTransTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSImageTitleNumberCell class]) bundle:nil] forCellReuseIdentifier:@"GYHSImageTitleNumberCell"];
    [self.cashTransTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSLabelTwoTableViewCell class]) bundle:nil] forCellReuseIdentifier:@"GYHSLabelTwoTableViewCell"];
    [self.cashTransTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSLableTextFileTableViewCell class]) bundle:nil] forCellReuseIdentifier:@"GYHSLableTextFileTableViewCell"];
    [self.cashTransTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSTowLabelButtonCell class]) bundle:nil] forCellReuseIdentifier:@"GYHSTowLabelButtonCell"];
    [self.cashTransTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSTableViewWarmCell class]) bundle:nil] forCellReuseIdentifier:@"GYHSTableViewWarmCell"];
    [self.cashTransTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSButtonCell class]) bundle:nil] forCellReuseIdentifier:@"GYHSButtonCell"];
    //查询个人信息非持卡人
    [self requestData];
    //查询是否有默认银行卡
