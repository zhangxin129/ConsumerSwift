...
- (void)viewDidLoad
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([CellDetailTwoRow class]) bundle:kDefaultBundle] forCellReuseIdentifier:kCellDetailTwoRowIdentifier];
