...
-(UITableView *)tableView {
    ...
    if(!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSResetTradingTableViewCell class]) bundle:nil] forCellReuseIdentifier:kGYHSResetTradingTableViewCellIdentifier];
