...
- (void)viewDidLoad {
    ...
    [self.tradingPasswordTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSLableTextFileTableViewCell class]) bundle:nil] forCellReuseIdentifier:@"GYHSLableTextFileTableViewCell"];
    [self.tradingPasswordTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSTableViewWarmCell class]) bundle:nil] forCellReuseIdentifier:@"GYHSTableViewWarmCell"];
    [self.tradingPasswordTableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSButtonCell class]) bundle:nil] forCellReuseIdentifier:@"GYHSButtonCell"];
}
...
-(NSArray*)textFiletitleArray
{
    if (!_textFiletitleArray) {
        if (self.tradingPasswordType == GYHSTradingPasswordTypeSet) {
            _textFiletitleArray = [NSArray arrayWithObjects:kLocalized(@"GYHS_Pwd_New_Pwd"),kLocalized(@"GYHS_Pwd_Login_Confirm_Pwd"), nil];
        }else {
            _textFiletitleArray = [NSArray arrayWithObjects:kLocalized(@"GYHS_Pwd_Original_Password"),kLocalized(@"GYHS_Pwd_New_Trade_Password"),kLocalized(@"GYHS_Pwd_Login_Confirm_Pwd"), nil];
        }
    }
