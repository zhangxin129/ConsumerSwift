...
- (UITableView*)tableView
{
    if (_tableView == nil) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSAddBankCardInfoTableViewCell class]) bundle:nil] forCellReuseIdentifier:GYHSBankCardDetail_Cell_Info_Identify];
        [_tableView registerNib:[UINib nibWithNibName:NSStringFromClass([GYHSButtonCell class]) bundle:nil] forCellReuseIdentifier:GYHSBankCardDetail_Cell_Button_Identify];
