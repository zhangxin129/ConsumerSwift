...
- (void)viewDidLoad
{
    ...
    [tvQuitPhoneBanding registerNib:[UINib nibWithNibName:NSStringFromClass([GYQuitPhoneBandingTableViewCell class]) bundle:nil] forCellReuseIdentifier:@"cell"];
...
{
    GYModifyEmailBandingViewController* vcModifyEmail = [[GYModifyEmailBandingViewController alloc] initWithNibName:NSStringFromClass([GYModifyEmailBandingViewController class]) bundle:nil];
    switch (index) {
        case 0: {
