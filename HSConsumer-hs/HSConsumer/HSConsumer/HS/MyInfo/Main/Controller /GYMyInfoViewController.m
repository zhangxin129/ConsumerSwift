...
//            if(self.isSetTradePwd == GYHSTradingPasswordTypeSet) {
                //问题密码找回。
                GYSetupPasswdQuestionViewController* vcCardBanding = [[GYSetupPasswdQuestionViewController alloc] initWithNibName:NSStringFromClass([GYSetupPasswdQuestionViewController class]) bundle:nil];
                sender = vcCardBanding;
//            }else {
