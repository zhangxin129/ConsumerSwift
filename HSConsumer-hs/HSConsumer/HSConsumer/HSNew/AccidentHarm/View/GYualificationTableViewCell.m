...
- (void)awakeFromNib {
    // Initialization code
    self.SecurityQualificationlb.font = kQualificationlbFont;
    self.lbcontent.font = kContentlbFont;
    self.lbTime.font = kContentlbFont;
    self.contentTitleLb.font = kContentlbFont;
    self.timeTitleLb.font = kContentlbFont;
}
