...
@interface GYHSDiePeopleViewController () <UICollectionViewDelegate, UICollectionViewDataSource, UINavigationControllerDelegate, UIImagePickerControllerDelegate,GYNetRequestDelegate>
...
@implementation GYHSDiePeopleViewController
...
#pragma mark - 懒加载
                     ...
                     - (UICollectionView*)collectionView
    {
        if (!_collectionView) {
            ...
            _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight-64-10) collectionViewLayout:flowLayout];
