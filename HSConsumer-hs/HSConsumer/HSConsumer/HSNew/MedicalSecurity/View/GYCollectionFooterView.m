...
- (void)awakeFromNib
{
    ...
    [str addAttribute:NSFontAttributeName value:kCollectionFooterFont range:NSMakeRange(0, length)];
    ...
    [self.btnapply setBackgroundImage:[UIImage imageNamed:@"gyhs_nextbtn"] forState:UIControlStateNormal];
    self.btnapply.layer.cornerRadius = 18.5;
    self.btnapply.clipsToBounds = YES;
    
    self.lbUploadinstructions.textColor = self.lbStructions.textColor;
