...
// 成功返回的关键名称, 默认：@"retCode"
@property (nonatomic, strong) NSString* returnCodeName;
// 成功的返回码:默认为：@200
@property (nonatomic, strong) NSMutableArray* returnCodeAry;
// 注册回调的忙等，会延迟1到2秒钟启动忙等框
@property (nonatomic, strong) GYBaseAnimating* animateObj;
