...
@interface GYPlaceholderTextView () <UITextViewDelegate>
...
@end
@implementation GYPlaceholderTextView
...
- (void)awakeFromNib
{
    ...
    [kDefaultNotificationCenter addObserver:self selector:@selector(DidChange:) name:UITextViewTextDidChangeNotification object:self];
    
    //UITextViewTextDidBeginEditingNotification
    [kDefaultNotificationCenter addObserver:self selector:@selector(textViewBeginNoti:) name:UITextViewTextDidBeginEditingNotification object:self];
    
    //UITextViewTextDidEndEditingNotification
    
    [kDefaultNotificationCenter addObserver:self selector:@selector(textViewEndNoti:) name:UITextViewTextDidEndEditingNotification object:self];
...
- (void)addTextViewBeginEvent:(void (^)(GYPlaceholderTextView*))begin
{

    _BeginBlock = begin;
}

- (void)addTextViewEndEvent:(void (^)(GYPlaceholderTextView*))End
{
    _EndBlock = End;
}
...
- (void)textViewBeginNoti:(NSNotification*)noti
{
    ...
    if (_BeginBlock) {
        void (^begin)(GYPlaceholderTextView* text) = _BeginBlock;
        begin(self);
    }
}
- (void)textViewEndNoti:(NSNotification*)noti
{
    ...
    if (_EndBlock) {
        void (^end)(GYPlaceholderTextView* text) = _EndBlock;
        end(self);
    }
}
...
- (void)DidChange:(NSNotification*)noti
{
    ...
    if (_eventBlock && self.text.length > self.maxTextLength) {
        ...
        void (^limint)(GYPlaceholderTextView* text) = _eventBlock;
