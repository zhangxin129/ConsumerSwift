...
typedef NS_ENUM(NSInteger, NSComparisonStringResult) { NSOrderedStringAscending = -1L,
    NSOrderedStringSame,
    NSOrderedStringDescending,
    NSOrderedStringOther };

@interface NSString (GYExtension)
#pragma mark - size
