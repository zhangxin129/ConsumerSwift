...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
        self.borderColor = RGB(102, 99, 100);
...
- (void)show
{
    self.handerView = [UIButton buttonWithType:UIButtonTypeRoundedRect];
...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    cell.backgroundView.backgroundColor = RGB(102, 99, 100);
    ...
    cell.contentView.backgroundColor = RGB(102, 99, 100);
