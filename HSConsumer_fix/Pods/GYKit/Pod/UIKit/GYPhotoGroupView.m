...
- (UIImage*)thumbImage
{
    if ([_thumbView respondsToSelector:@selector(image)]) {
        return ((UIImageView*)_thumbView).image ? ((UIImageView*)_thumbView).image : [UIImage imageNamed:@"gycommon_image_placeholder"];
    }
    return [UIImage imageNamed:@"gycommon_image_placeholder"];
}
