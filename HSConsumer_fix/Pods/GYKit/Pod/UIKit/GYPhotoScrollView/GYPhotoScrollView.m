...
- (void)setPhotos:(NSArray*)photos
{
    ...
    for (int i = 0; i < photos.count; i++) {
        ...
        [imageView setImageWithURL:[NSURL URLWithString:photos[i]] placeholder:[UIImage imageNamed:@"gycommon_image_placeholder"] options:YYWebImageOptionProgressive completion:nil];
