...
//    [_mapView addAnnotation:_annotation];
    ...
    [busButton setBackgroundImage:[UIImage imageNamed:@"gyhd_bus_select"] forState:UIControlStateHighlighted];
    ...
    [driverButton setBackgroundImage:[UIImage imageNamed:@"gyhd_drive_select"] forState:UIControlStateHighlighted];
    ...
    [walkButton setBackgroundImage:[UIImage imageNamed:@"gyhd_walk_select"] forState:UIControlStateHighlighted];
...
//sendDict[@"map_name"] = self.selectGPSmodel.title;
//sendDict[@"map_address"] = self.selectGPSmodel.address;
//sendDict[@"map_lng"] = [NSString stringWithFormat:@"%f",self.selectGPSmodel.pt.longitude];
//sendDict[@"map_lat"] = [NSString stringWithFormat:@"%f",self.selectGPSmodel.pt.latitude];
//sendDict[@"map_poi"] = @"";
...
//            annotationView.pinColor = BMKPinAnnotationColorPurple;
            ...
            CGSize titleSize = [GYUtils sizeForString:titleString font:kGYOtherDescriptionFont width:160];
            
            NSString *addressString = self.locationDict[@"map_address"];
            CGSize addressSize = [GYUtils sizeForString:addressString font:kGYOtherDescriptionFont width:160];
            ...
            paoImageView.frame = CGRectMake(0, 0, 172, popH);
    ...
    if (error == BMK_SEARCH_NO_ERROR) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if(i==0){
                ...
                item.title = [GYUtils localizedStringWithKey:@"GYHD_map_start_position"];
                item.type = 0;
                ...
                item.title = [GYUtils localizedStringWithKey:@"GYHD_map_end_position"];
                item.type = 1;
                [_mapView addAnnotation:item]; // 添加起点标注
            }
            GYHDRouteAnnotation* item = [[GYHDRouteAnnotation alloc]init];
