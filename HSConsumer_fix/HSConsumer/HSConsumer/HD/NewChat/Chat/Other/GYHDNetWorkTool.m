...
- (void)getFriendListRequetResult:(RequetResultWithDict)handler
{
    ...
    //    globalData.loginModel.hdbizDomain = @"http://192.168.41.193:8098/hsim-bservice/queryFriendList";
    NSString* ustring = [NSString stringWithFormat:@"%@/hsim-bservice/queryFriendList", self.bserviceDomain];
...
- (void)postImageWithData:(NSData*)data RequetResult:(RequetResultWithDict)handler
{
    ...
    NSString* urlString = [NSString stringWithFormat:@"%@/hsim-img-center/upload/imageUpload?type=%@&fileType=%@&custId=%@&id=%@&loginToken=%@&channelType=4", self.imgCenterDomain, @"default", @"image", globalData.loginModel.custId, globalData.loginModel.resNo, globalData.loginModel.token];
...
- (void)postAudioWithData:(NSData*)data RequetResult:(RequetResultWithDict)handler
{
    ...
    NSString* urlString = [NSString stringWithFormat:@"%@/hsim-img-center/upload/audioUpload?type=%@&fileType=%@&custId=%@&id=%@&loginToken=%@&channelType=4", self.imgCenterDomain, @"default", @"audio", globalData.loginModel.custId, globalData.loginModel.resNo, globalData.loginModel.token];
...
{
    NSString* urlString = [NSString stringWithFormat:@"%@/hsim-img-center/upload/videoUpload?type=%@&fileType=%@&custId=%@&id=%@&loginToken=%@&channelType=4", self.imgCenterDomain, @"default", @"video", globalData.loginModel.custId, globalData.loginModel.resNo, globalData.loginModel.token];
...
- (void)bindFileToUserWithDict:(NSDictionary*)dict RequestResult:(RequetResultWithDict)handler {

    NSString* urlString = [NSString stringWithFormat:@"%@/hsim-img-center/bindUser/fileRecordBindUser", globalData.loginModel.hdimImgcAddr];
    
    [[[GYNetRequest alloc] initWithBlock:urlString  parameters:dict requestMethod:GYNetRequestMethodPOST requestSerializer:GYNetRequestSerializerJSON respondBlock:^(NSDictionary *responseObject, NSError *error) {
        NSLog(@"%@",responseObject);
        handler(responseObject);
    }] start];
