...
NSString* NSStringFromServiceID_(ServiceID_ value)
{
    ...
    case ServiceID_SidFile:
        return @"ServiceID_SidFile";
    case ServiceID_SidSwitchService:
        return @"ServiceID_SidSwitchService";
    case ServiceID_SidOther:
        return @"ServiceID_SidOther";
    case ServiceID_SidInternal:
        return @"ServiceID_SidInternal";
    default:
        return nil;
    }
}
...
{
    switch (value) {
    case ServerIDServerStatus:
    case ServerIDServerGroupQuery:
    case ServerIDServerMonitor:
    case ServerIDServerMessage:
    case ServerIDServerRouter:
    case ServerIDServerGroup:
    case ServerIDServerDba:
    case ServerIDServerApns:
        return YES;
    default:
        return NO;
    }
...
NSString* NSStringFromServerID(ServerID value)
{
    switch (value) {
    case ServerIDServerStatus:
        return @"ServerIDServerStatus";
    case ServerIDServerGroupQuery:
        return @"ServerIDServerGroupQuery";
    case ServerIDServerMonitor:
        return @"ServerIDServerMonitor";
    case ServerIDServerMessage:
        return @"ServerIDServerMessage";
    case ServerIDServerRouter:
        return @"ServerIDServerRouter";
    case ServerIDServerGroup:
        return @"ServerIDServerGroup";
    case ServerIDServerDba:
        return @"ServerIDServerDba";
    case ServerIDServerApns:
        return @"ServerIDServerApns";
    default:
        return nil;
    }
}
...
{
    switch (value) {
    case ClientServerCmdIDCidRegReq:
    case ClientServerCmdIDCidRegRsp:
        return YES;
    default:
        return NO;
    }
...
NSString* NSStringFromClientServerCmdID(ClientServerCmdID value)
{
    switch (value) {
    case ClientServerCmdIDCidRegReq:
        return @"ClientServerCmdIDCidRegReq";
    case ClientServerCmdIDCidRegRsp:
        return @"ClientServerCmdIDCidRegRsp";
    default:
        return nil;
    }
}
...
{
    switch (value) {
    case MonitorCmdIDCidMonitorServerRegReq:
    case MonitorCmdIDCidMonitorServerRegRsp:
    case MonitorCmdIDCidMonitorServerListGetReq:
    case MonitorCmdIDCidMonitorServerListGetRsp:
    case MonitorCmdIDCidMonitorServerUpdateNotice:
    case MonitorCmdIDCidMonitorServerUpdateNoticeRsp:
        return YES;
    default:
        return NO;
    }
...
NSString* NSStringFromMonitorCmdID(MonitorCmdID value)
{
    switch (value) {
    case MonitorCmdIDCidMonitorServerRegReq:
        return @"MonitorCmdIDCidMonitorServerRegReq";
    case MonitorCmdIDCidMonitorServerRegRsp:
        return @"MonitorCmdIDCidMonitorServerRegRsp";
    case MonitorCmdIDCidMonitorServerListGetReq:
        return @"MonitorCmdIDCidMonitorServerListGetReq";
    case MonitorCmdIDCidMonitorServerListGetRsp:
        return @"MonitorCmdIDCidMonitorServerListGetRsp";
    case MonitorCmdIDCidMonitorServerUpdateNotice:
        return @"MonitorCmdIDCidMonitorServerUpdateNotice";
    case MonitorCmdIDCidMonitorServerUpdateNoticeRsp:
        return @"MonitorCmdIDCidMonitorServerUpdateNoticeRsp";
    default:
        return nil;
    }
}
...
{
    switch (value) {
    case MsgCmdIDCidMessageRecentMsg:
    case MsgCmdIDCidMessageRecentMsgAck:
    case MsgCmdIDCidMessageOfflineMsg:
    case MsgCmdIDCidMessageOfflineMsgAck:
    case MsgCmdIDCidMessageBuddyGroupList:
    case MsgCmdIDCidMessageBuddyGroupListAck:
    case MsgCmdIDCidMessageBuddyList:
    case MsgCmdIDCidMessageBuddyListAck:
    case MsgCmdIDCidMessageChatMsg:
    case MsgCmdIDCidMessageChatMsgAck:
    case MsgCmdIDCidMessageMsgAck:
    case MsgCmdIDCidMessageModifySubgroup:
    case MsgCmdIDCidMessageModifySubgroupAck:
    case MsgCmdIDCidMessageAddBuddy:
    case MsgCmdIDCidMessageAddBuddyAck:
    case MsgCmdIDCidMessageBuddyVerify:
    case MsgCmdIDCidMessageBuddyVerifyAck:
    case MsgCmdIDCidMessageDeleteBuddy:
    case MsgCmdIDCidMessageDeleteBuddyAck:
    case MsgCmdIDCidMessageSystemMsgList:
    case MsgCmdIDCidMessageSystemMsgListAck:
    case MsgCmdIDCidMessageLoginReq:
    case MsgCmdIDCidMessageLoginRes:
    case MsgCmdIDCidMessageLoginOutReq:
    case MsgCmdIDCidMessageLoginOutRes:
    case MsgCmdIDCidMessageReloginReq:
    case MsgCmdIDCidMessageReloginRes:
    case MsgCmdIDCidMessagePushNotify:
    case MsgCmdIDCidMessagePushAck:
    case MsgCmdIDCidMessagePushMsgsRsp:
        return YES;
    default:
        return NO;
    }
...
NSString* NSStringFromMsgCmdID(MsgCmdID value)
{
    switch (value) {
    case MsgCmdIDCidMessageRecentMsg:
        return @"MsgCmdIDCidMessageRecentMsg";
    case MsgCmdIDCidMessageRecentMsgAck:
        return @"MsgCmdIDCidMessageRecentMsgAck";
    case MsgCmdIDCidMessageOfflineMsg:
        return @"MsgCmdIDCidMessageOfflineMsg";
    case MsgCmdIDCidMessageOfflineMsgAck:
        return @"MsgCmdIDCidMessageOfflineMsgAck";
    case MsgCmdIDCidMessageBuddyGroupList:
        return @"MsgCmdIDCidMessageBuddyGroupList";
    case MsgCmdIDCidMessageBuddyGroupListAck:
        return @"MsgCmdIDCidMessageBuddyGroupListAck";
    case MsgCmdIDCidMessageBuddyList:
        return @"MsgCmdIDCidMessageBuddyList";
    case MsgCmdIDCidMessageBuddyListAck:
        return @"MsgCmdIDCidMessageBuddyListAck";
    case MsgCmdIDCidMessageChatMsg:
        return @"MsgCmdIDCidMessageChatMsg";
    case MsgCmdIDCidMessageChatMsgAck:
        return @"MsgCmdIDCidMessageChatMsgAck";
    case MsgCmdIDCidMessageMsgAck:
        return @"MsgCmdIDCidMessageMsgAck";
    case MsgCmdIDCidMessageModifySubgroup:
        return @"MsgCmdIDCidMessageModifySubgroup";
    case MsgCmdIDCidMessageModifySubgroupAck:
        return @"MsgCmdIDCidMessageModifySubgroupAck";
    case MsgCmdIDCidMessageAddBuddy:
        return @"MsgCmdIDCidMessageAddBuddy";
    case MsgCmdIDCidMessageAddBuddyAck:
        return @"MsgCmdIDCidMessageAddBuddyAck";
    case MsgCmdIDCidMessageBuddyVerify:
        return @"MsgCmdIDCidMessageBuddyVerify";
    case MsgCmdIDCidMessageBuddyVerifyAck:
        return @"MsgCmdIDCidMessageBuddyVerifyAck";
    case MsgCmdIDCidMessageDeleteBuddy:
        return @"MsgCmdIDCidMessageDeleteBuddy";
    case MsgCmdIDCidMessageDeleteBuddyAck:
        return @"MsgCmdIDCidMessageDeleteBuddyAck";
    case MsgCmdIDCidMessageSystemMsgList:
        return @"MsgCmdIDCidMessageSystemMsgList";
    case MsgCmdIDCidMessageSystemMsgListAck:
        return @"MsgCmdIDCidMessageSystemMsgListAck";
    case MsgCmdIDCidMessageLoginReq:
        return @"MsgCmdIDCidMessageLoginReq";
    case MsgCmdIDCidMessageLoginRes:
        return @"MsgCmdIDCidMessageLoginRes";
    case MsgCmdIDCidMessageLoginOutReq:
        return @"MsgCmdIDCidMessageLoginOutReq";
    case MsgCmdIDCidMessageLoginOutRes:
        return @"MsgCmdIDCidMessageLoginOutRes";
    case MsgCmdIDCidMessageReloginReq:
        return @"MsgCmdIDCidMessageReloginReq";
    case MsgCmdIDCidMessageReloginRes:
        return @"MsgCmdIDCidMessageReloginRes";
    case MsgCmdIDCidMessagePushNotify:
        return @"MsgCmdIDCidMessagePushNotify";
    case MsgCmdIDCidMessagePushAck:
        return @"MsgCmdIDCidMessagePushAck";
    case MsgCmdIDCidMessagePushMsgsRsp:
        return @"MsgCmdIDCidMessagePushMsgsRsp";
    default:
        return nil;
    }
}
...
{
    switch (value) {
    case RouterCmdIDCidRouterUserModStateReq:
    case RouterCmdIDCidRouterUserModStateRsp:
    case RouterCmdIDCidRouterUserStateReq:
    case RouterCmdIDCidRouterUserStateRsp:
    case RouterCmdIDCidRouterUserStateNotify:
    case RouterCmdIDCidRouterKickoutNotify:
        return YES;
    default:
        return NO;
    }
...
NSString* NSStringFromRouterCmdID(RouterCmdID value)
{
    switch (value) {
    case RouterCmdIDCidRouterUserModStateReq:
        return @"RouterCmdIDCidRouterUserModStateReq";
    case RouterCmdIDCidRouterUserModStateRsp:
        return @"RouterCmdIDCidRouterUserModStateRsp";
    case RouterCmdIDCidRouterUserStateReq:
        return @"RouterCmdIDCidRouterUserStateReq";
    case RouterCmdIDCidRouterUserStateRsp:
        return @"RouterCmdIDCidRouterUserStateRsp";
    case RouterCmdIDCidRouterUserStateNotify:
        return @"RouterCmdIDCidRouterUserStateNotify";
    case RouterCmdIDCidRouterKickoutNotify:
        return @"RouterCmdIDCidRouterKickoutNotify";
    default:
        return nil;
    }
}
...
{
    switch (value) {
    case StatusCmdIDCidStatusModUserStateReq:
    case StatusCmdIDCidStatusModUserStateRsp:
    case StatusCmdIDCidStatusGetUserStateReq:
    case StatusCmdIDCidStatusGetUserStateRsp:
    case StatusCmdIDCidGetUserLoginInfoReq:
    case StatusCmdIDCidGetUserLoginInfoRsp:
        return YES;
    default:
        return NO;
    }
...
NSString* NSStringFromStatusCmdID(StatusCmdID value)
{
    switch (value) {
    case StatusCmdIDCidStatusModUserStateReq:
        return @"StatusCmdIDCidStatusModUserStateReq";
    case StatusCmdIDCidStatusModUserStateRsp:
        return @"StatusCmdIDCidStatusModUserStateRsp";
    case StatusCmdIDCidStatusGetUserStateReq:
        return @"StatusCmdIDCidStatusGetUserStateReq";
    case StatusCmdIDCidStatusGetUserStateRsp:
        return @"StatusCmdIDCidStatusGetUserStateRsp";
    case StatusCmdIDCidGetUserLoginInfoReq:
        return @"StatusCmdIDCidGetUserLoginInfoReq";
    case StatusCmdIDCidGetUserLoginInfoRsp:
        return @"StatusCmdIDCidGetUserLoginInfoRsp";
    default:
        return nil;
    }
}
...
{
    switch (value) {
    case GroupCmdIDCidGroupUserOnlineNotify:
    case GroupCmdIDCidGroupUserGroupInfoNotify:
    case GroupCmdIDCidGroupUserMemberReq:
    case GroupCmdIDCidGroupUserMemberRsp:
    case GroupCmdIDCidGroupCreateNewReq:
    case GroupCmdIDCidGroupCreateNewRsp:
    case GroupCmdIDCidGroupInviteUserReq:
    case GroupCmdIDCidGroupInviteUserRsp:
    case GroupCmdIDCidGroupUserJoininNotify:
    case GroupCmdIDCidGroupKickoutReq:
    case GroupCmdIDCidGroupKickoutRsp:
    case GroupCmdIDCidGroupUserLeaveNotify:
    case GroupCmdIDCidGroupQueryReq:
    case GroupCmdIDCidGroupQueryRsp:
    case GroupCmdIDCidGroupUserApplyReq:
    case GroupCmdIDCidGroupUserApplyRsp:
    case GroupCmdIDCidGroupApplyInNotify:
    case GroupCmdIDCidGroupValidateReq:
    case GroupCmdIDCidGroupValidateRsp:
    case GroupCmdIDCidGroupModReq:
    case GroupCmdIDCidGroupModRsp:
    case GroupCmdIDCidGroupUpdateNotify:
    case GroupCmdIDCidGroupQuitReq:
    case GroupCmdIDCidGroupQuitRsp:
    case GroupCmdIDCidGroupDismissReq:
    case GroupCmdIDCidGroupDismissRsp:
        return YES;
    default:
        return NO;
    }
...
NSString* NSStringFromGroupCmdID(GroupCmdID value)
{
    switch (value) {
    case GroupCmdIDCidGroupUserOnlineNotify:
        return @"GroupCmdIDCidGroupUserOnlineNotify";
    case GroupCmdIDCidGroupUserGroupInfoNotify:
        return @"GroupCmdIDCidGroupUserGroupInfoNotify";
    case GroupCmdIDCidGroupUserMemberReq:
        return @"GroupCmdIDCidGroupUserMemberReq";
    case GroupCmdIDCidGroupUserMemberRsp:
        return @"GroupCmdIDCidGroupUserMemberRsp";
    case GroupCmdIDCidGroupCreateNewReq:
        return @"GroupCmdIDCidGroupCreateNewReq";
    case GroupCmdIDCidGroupCreateNewRsp:
        return @"GroupCmdIDCidGroupCreateNewRsp";
    case GroupCmdIDCidGroupInviteUserReq:
        return @"GroupCmdIDCidGroupInviteUserReq";
    case GroupCmdIDCidGroupInviteUserRsp:
        return @"GroupCmdIDCidGroupInviteUserRsp";
    case GroupCmdIDCidGroupUserJoininNotify:
        return @"GroupCmdIDCidGroupUserJoininNotify";
    case GroupCmdIDCidGroupKickoutReq:
        return @"GroupCmdIDCidGroupKickoutReq";
    case GroupCmdIDCidGroupKickoutRsp:
        return @"GroupCmdIDCidGroupKickoutRsp";
    case GroupCmdIDCidGroupUserLeaveNotify:
        return @"GroupCmdIDCidGroupUserLeaveNotify";
    case GroupCmdIDCidGroupQueryReq:
        return @"GroupCmdIDCidGroupQueryReq";
    case GroupCmdIDCidGroupQueryRsp:
        return @"GroupCmdIDCidGroupQueryRsp";
    case GroupCmdIDCidGroupUserApplyReq:
        return @"GroupCmdIDCidGroupUserApplyReq";
    case GroupCmdIDCidGroupUserApplyRsp:
        return @"GroupCmdIDCidGroupUserApplyRsp";
    case GroupCmdIDCidGroupApplyInNotify:
        return @"GroupCmdIDCidGroupApplyInNotify";
    case GroupCmdIDCidGroupValidateReq:
        return @"GroupCmdIDCidGroupValidateReq";
    case GroupCmdIDCidGroupValidateRsp:
        return @"GroupCmdIDCidGroupValidateRsp";
    case GroupCmdIDCidGroupModReq:
        return @"GroupCmdIDCidGroupModReq";
    case GroupCmdIDCidGroupModRsp:
        return @"GroupCmdIDCidGroupModRsp";
    case GroupCmdIDCidGroupUpdateNotify:
        return @"GroupCmdIDCidGroupUpdateNotify";
    case GroupCmdIDCidGroupQuitReq:
        return @"GroupCmdIDCidGroupQuitReq";
    case GroupCmdIDCidGroupQuitRsp:
        return @"GroupCmdIDCidGroupQuitRsp";
    case GroupCmdIDCidGroupDismissReq:
        return @"GroupCmdIDCidGroupDismissReq";
    case GroupCmdIDCidGroupDismissRsp:
        return @"GroupCmdIDCidGroupDismissRsp";
    default:
        return nil;
    }
}
...
{
    switch (value) {
    case GroupQueryCmdIDCidGqIsGroupNameExistReq:
    case GroupQueryCmdIDCidGqIsGroupNameExistRsp:
    case GroupQueryCmdIDCidGqGetUserCreateGroupMaxNumReq:
    case GroupQueryCmdIDCidGqGetUserCreateGroupMaxNumRsp:
    case GroupQueryCmdIDCidGqGetUserCreateGroupNumReq:
    case GroupQueryCmdIDCidGqGetUserCreateGroupNumRsp:
    case GroupQueryCmdIDCidGqGetGroupListReq:
    case GroupQueryCmdIDCidGqGetGroupListRsp:
    case GroupQueryCmdIDCidGqGetGroupByIdReq:
    case GroupQueryCmdIDCidGqGetGroupByIdRsp:
    case GroupQueryCmdIDCidGqGetGroupByKeyReq:
    case GroupQueryCmdIDCidGqGetGroupByKeyRsp:
    case GroupQueryCmdIDCidGqCreateGroupReq:
    case GroupQueryCmdIDCidGqCreateGroupRsp:
    case GroupQueryCmdIDCidGqRemoveGroupReq:
    case GroupQueryCmdIDCidGqRemoveGroupRsp:
    case GroupQueryCmdIDCidGqModifyGroupReq:
    case GroupQueryCmdIDCidGqModifyGroupRsp:
    case GroupQueryCmdIDCidGqGetGroupMemberListReq:
    case GroupQueryCmdIDCidGqGetGroupMemberListRsp:
    case GroupQueryCmdIDCidGqGetGroupMemberInfoReq:
    case GroupQueryCmdIDCidGqGetGroupMemberInfoRsp:
    case GroupQueryCmdIDCidGqAddMemberToGroupReq:
    case GroupQueryCmdIDCidGqAddMemberToGroupRsp:
    case GroupQueryCmdIDCidGqRemoveMemberReq:
    case GroupQueryCmdIDCidGqRemoveMemberRsp:
    case GroupQueryCmdIDCidGqModifyMemberInfoReq:
    case GroupQueryCmdIDCidGqModifyMemberInfoRsp:
    case GroupQueryCmdIDCidGqGetUserPriorityReq:
    case GroupQueryCmdIDCidGqGetUserPriorityRsp:
        return YES;
    default:
        return NO;
    }
...
NSString* NSStringFromGroupQueryCmdID(GroupQueryCmdID value)
{
    switch (value) {
    case GroupQueryCmdIDCidGqIsGroupNameExistReq:
        return @"GroupQueryCmdIDCidGqIsGroupNameExistReq";
    case GroupQueryCmdIDCidGqIsGroupNameExistRsp:
        return @"GroupQueryCmdIDCidGqIsGroupNameExistRsp";
    case GroupQueryCmdIDCidGqGetUserCreateGroupMaxNumReq:
        return @"GroupQueryCmdIDCidGqGetUserCreateGroupMaxNumReq";
    case GroupQueryCmdIDCidGqGetUserCreateGroupMaxNumRsp:
        return @"GroupQueryCmdIDCidGqGetUserCreateGroupMaxNumRsp";
    case GroupQueryCmdIDCidGqGetUserCreateGroupNumReq:
        return @"GroupQueryCmdIDCidGqGetUserCreateGroupNumReq";
    case GroupQueryCmdIDCidGqGetUserCreateGroupNumRsp:
        return @"GroupQueryCmdIDCidGqGetUserCreateGroupNumRsp";
    case GroupQueryCmdIDCidGqGetGroupListReq:
        return @"GroupQueryCmdIDCidGqGetGroupListReq";
    case GroupQueryCmdIDCidGqGetGroupListRsp:
        return @"GroupQueryCmdIDCidGqGetGroupListRsp";
    case GroupQueryCmdIDCidGqGetGroupByIdReq:
        return @"GroupQueryCmdIDCidGqGetGroupByIdReq";
    case GroupQueryCmdIDCidGqGetGroupByIdRsp:
        return @"GroupQueryCmdIDCidGqGetGroupByIdRsp";
    case GroupQueryCmdIDCidGqGetGroupByKeyReq:
        return @"GroupQueryCmdIDCidGqGetGroupByKeyReq";
    case GroupQueryCmdIDCidGqGetGroupByKeyRsp:
        return @"GroupQueryCmdIDCidGqGetGroupByKeyRsp";
    case GroupQueryCmdIDCidGqCreateGroupReq:
        return @"GroupQueryCmdIDCidGqCreateGroupReq";
    case GroupQueryCmdIDCidGqCreateGroupRsp:
        return @"GroupQueryCmdIDCidGqCreateGroupRsp";
    case GroupQueryCmdIDCidGqRemoveGroupReq:
        return @"GroupQueryCmdIDCidGqRemoveGroupReq";
    case GroupQueryCmdIDCidGqRemoveGroupRsp:
        return @"GroupQueryCmdIDCidGqRemoveGroupRsp";
    case GroupQueryCmdIDCidGqModifyGroupReq:
        return @"GroupQueryCmdIDCidGqModifyGroupReq";
    case GroupQueryCmdIDCidGqModifyGroupRsp:
        return @"GroupQueryCmdIDCidGqModifyGroupRsp";
    case GroupQueryCmdIDCidGqGetGroupMemberListReq:
        return @"GroupQueryCmdIDCidGqGetGroupMemberListReq";
    case GroupQueryCmdIDCidGqGetGroupMemberListRsp:
        return @"GroupQueryCmdIDCidGqGetGroupMemberListRsp";
    case GroupQueryCmdIDCidGqGetGroupMemberInfoReq:
        return @"GroupQueryCmdIDCidGqGetGroupMemberInfoReq";
    case GroupQueryCmdIDCidGqGetGroupMemberInfoRsp:
        return @"GroupQueryCmdIDCidGqGetGroupMemberInfoRsp";
    case GroupQueryCmdIDCidGqAddMemberToGroupReq:
        return @"GroupQueryCmdIDCidGqAddMemberToGroupReq";
    case GroupQueryCmdIDCidGqAddMemberToGroupRsp:
        return @"GroupQueryCmdIDCidGqAddMemberToGroupRsp";
    case GroupQueryCmdIDCidGqRemoveMemberReq:
        return @"GroupQueryCmdIDCidGqRemoveMemberReq";
    case GroupQueryCmdIDCidGqRemoveMemberRsp:
        return @"GroupQueryCmdIDCidGqRemoveMemberRsp";
    case GroupQueryCmdIDCidGqModifyMemberInfoReq:
        return @"GroupQueryCmdIDCidGqModifyMemberInfoReq";
    case GroupQueryCmdIDCidGqModifyMemberInfoRsp:
        return @"GroupQueryCmdIDCidGqModifyMemberInfoRsp";
    case GroupQueryCmdIDCidGqGetUserPriorityReq:
        return @"GroupQueryCmdIDCidGqGetUserPriorityReq";
    case GroupQueryCmdIDCidGqGetUserPriorityRsp:
        return @"GroupQueryCmdIDCidGqGetUserPriorityRsp";
    default:
        return nil;
    }
}
...
{
    switch (value) {
    case DBACmdIDCidDbaAddBuddy:
    case DBACmdIDCidDbaAddBuddyAck:
    case DBACmdIDCidDbaBuddyVerify:
    case DBACmdIDCidDbaBuddyVerifyAck:
    case DBACmdIDCidDbaGetGroupList:
    case DBACmdIDCidDbaGetGroupListAck:
    case DBACmdIDCidDbaLogin:
    case DBACmdIDCidDbaLoginAck:
    case DBACmdIDCidDbaGetGroupserverIp:
    case DBACmdIDCidDbaGetGroupserverIpAck:
    case DBACmdIDCidDbaGetUserStatus:
    case DBACmdIDCidDbaGetUserStatusAck:
    case DBACmdIDCidDbaModUserStatus:
    case DBACmdIDCidDbaModUserStatusAck:
    case DBACmdIDCidDbaSetMsgReadPos:
    case DBACmdIDCidDbaSetMsgReadPosAck:
    case DBACmdIDCidDbaSetSysmsgRead:
    case DBACmdIDCidDbaSetSysmsgReadAck:
    case DBACmdIDCidDbaSaveServerList:
    case DBACmdIDCidDbaSaveServerListAck:
    case DBACmdIDCidDbaGetServerList:
    case DBACmdIDCidDbaGetServerListAck:
    case DBACmdIDCidDbaIsGroupNameExistReq:
    case DBACmdIDCidDbaIsGroupNameExistRsp:
    case DBACmdIDCidDbaGetUserCreateGroupMaxNumReq:
    case DBACmdIDCidDbaGetUserCreateGroupMaxNumRsp:
    case DBACmdIDCidDbaGetUserCreateGroupNumReq:
    case DBACmdIDCidDbaGetUserCreateGroupNumRsp:
    case DBACmdIDCidDbaGetGroupListReq:
    case DBACmdIDCidDbaGetGroupListRsp:
    case DBACmdIDCidDbaGetGroupByIdReq:
    case DBACmdIDCidDbaGetGroupByIdRsp:
    case DBACmdIDCidDbaGetGroupByKeyReq:
    case DBACmdIDCidDbaGetGroupByKeyRsp:
    case DBACmdIDCidDbaCreateGroupReq:
    case DBACmdIDCidDbaCreateGroupRsp:
    case DBACmdIDCidDbaRemoveGroupReq:
    case DBACmdIDCidDbaRemoveGroupRsp:
    case DBACmdIDCidDbaModifyGroupReq:
    case DBACmdIDCidDbaModifyGroupRsp:
    case DBACmdIDCidDbaGetGroupMemberListReq:
    case DBACmdIDCidDbaGetGroupMemberListRsp:
    case DBACmdIDCidDbaGetGroupMemberInfoReq:
    case DBACmdIDCidDbaGetGroupMemberInfoRsp:
    case DBACmdIDCidDbaAddMemberToGroupReq:
    case DBACmdIDCidDbaAddMemberToGroupRsp:
    case DBACmdIDCidDbaRemoveMemberReq:
    case DBACmdIDCidDbaRemoveMemberRsp:
    case DBACmdIDCidDbaModifyMemberInfoReq:
    case DBACmdIDCidDbaModifyMemberInfoRsp:
    case DBACmdIDCidDbaGetUserPriorityReq:
    case DBACmdIDCidDbaGetUserPriorityRsp:
    case DBACmdIDCidDbaSavePushMsg:
    case DBACmdIDCidDbaSavePushMsgAck:
    case DBACmdIDCidDbaSavePushMsgRela:
    case DBACmdIDCidDbaSavePushMsgRelaAck:
    case DBACmdIDCidDbaRecvPushMsg:
    case DBACmdIDCidDbaRecvPushMsgAck:
        return YES;
    default:
        return NO;
    }
...
NSString* NSStringFromDBACmdID(DBACmdID value)
{
    switch (value) {
    case DBACmdIDCidDbaAddBuddy:
        return @"DBACmdIDCidDbaAddBuddy";
    case DBACmdIDCidDbaAddBuddyAck:
        return @"DBACmdIDCidDbaAddBuddyAck";
    case DBACmdIDCidDbaBuddyVerify:
        return @"DBACmdIDCidDbaBuddyVerify";
    case DBACmdIDCidDbaBuddyVerifyAck:
        return @"DBACmdIDCidDbaBuddyVerifyAck";
    case DBACmdIDCidDbaGetGroupList:
        return @"DBACmdIDCidDbaGetGroupList";
    case DBACmdIDCidDbaGetGroupListAck:
        return @"DBACmdIDCidDbaGetGroupListAck";
    case DBACmdIDCidDbaLogin:
        return @"DBACmdIDCidDbaLogin";
    case DBACmdIDCidDbaLoginAck:
        return @"DBACmdIDCidDbaLoginAck";
    case DBACmdIDCidDbaGetGroupserverIp:
        return @"DBACmdIDCidDbaGetGroupserverIp";
    case DBACmdIDCidDbaGetGroupserverIpAck:
        return @"DBACmdIDCidDbaGetGroupserverIpAck";
    case DBACmdIDCidDbaGetUserStatus:
        return @"DBACmdIDCidDbaGetUserStatus";
    case DBACmdIDCidDbaGetUserStatusAck:
        return @"DBACmdIDCidDbaGetUserStatusAck";
    case DBACmdIDCidDbaModUserStatus:
        return @"DBACmdIDCidDbaModUserStatus";
    case DBACmdIDCidDbaModUserStatusAck:
        return @"DBACmdIDCidDbaModUserStatusAck";
    case DBACmdIDCidDbaSetMsgReadPos:
        return @"DBACmdIDCidDbaSetMsgReadPos";
    case DBACmdIDCidDbaSetMsgReadPosAck:
        return @"DBACmdIDCidDbaSetMsgReadPosAck";
    case DBACmdIDCidDbaSetSysmsgRead:
        return @"DBACmdIDCidDbaSetSysmsgRead";
    case DBACmdIDCidDbaSetSysmsgReadAck:
        return @"DBACmdIDCidDbaSetSysmsgReadAck";
    case DBACmdIDCidDbaSaveServerList:
        return @"DBACmdIDCidDbaSaveServerList";
    case DBACmdIDCidDbaSaveServerListAck:
        return @"DBACmdIDCidDbaSaveServerListAck";
    case DBACmdIDCidDbaGetServerList:
        return @"DBACmdIDCidDbaGetServerList";
    case DBACmdIDCidDbaGetServerListAck:
        return @"DBACmdIDCidDbaGetServerListAck";
    case DBACmdIDCidDbaIsGroupNameExistReq:
        return @"DBACmdIDCidDbaIsGroupNameExistReq";
    case DBACmdIDCidDbaIsGroupNameExistRsp:
        return @"DBACmdIDCidDbaIsGroupNameExistRsp";
    case DBACmdIDCidDbaGetUserCreateGroupMaxNumReq:
        return @"DBACmdIDCidDbaGetUserCreateGroupMaxNumReq";
    case DBACmdIDCidDbaGetUserCreateGroupMaxNumRsp:
        return @"DBACmdIDCidDbaGetUserCreateGroupMaxNumRsp";
    case DBACmdIDCidDbaGetUserCreateGroupNumReq:
        return @"DBACmdIDCidDbaGetUserCreateGroupNumReq";
    case DBACmdIDCidDbaGetUserCreateGroupNumRsp:
        return @"DBACmdIDCidDbaGetUserCreateGroupNumRsp";
    case DBACmdIDCidDbaGetGroupListReq:
        return @"DBACmdIDCidDbaGetGroupListReq";
    case DBACmdIDCidDbaGetGroupListRsp:
        return @"DBACmdIDCidDbaGetGroupListRsp";
    case DBACmdIDCidDbaGetGroupByIdReq:
        return @"DBACmdIDCidDbaGetGroupByIdReq";
    case DBACmdIDCidDbaGetGroupByIdRsp:
        return @"DBACmdIDCidDbaGetGroupByIdRsp";
    case DBACmdIDCidDbaGetGroupByKeyReq:
        return @"DBACmdIDCidDbaGetGroupByKeyReq";
    case DBACmdIDCidDbaGetGroupByKeyRsp:
        return @"DBACmdIDCidDbaGetGroupByKeyRsp";
    case DBACmdIDCidDbaCreateGroupReq:
        return @"DBACmdIDCidDbaCreateGroupReq";
    case DBACmdIDCidDbaCreateGroupRsp:
        return @"DBACmdIDCidDbaCreateGroupRsp";
    case DBACmdIDCidDbaRemoveGroupReq:
        return @"DBACmdIDCidDbaRemoveGroupReq";
    case DBACmdIDCidDbaRemoveGroupRsp:
        return @"DBACmdIDCidDbaRemoveGroupRsp";
    case DBACmdIDCidDbaModifyGroupReq:
        return @"DBACmdIDCidDbaModifyGroupReq";
    case DBACmdIDCidDbaModifyGroupRsp:
        return @"DBACmdIDCidDbaModifyGroupRsp";
    case DBACmdIDCidDbaGetGroupMemberListReq:
        return @"DBACmdIDCidDbaGetGroupMemberListReq";
    case DBACmdIDCidDbaGetGroupMemberListRsp:
        return @"DBACmdIDCidDbaGetGroupMemberListRsp";
    case DBACmdIDCidDbaGetGroupMemberInfoReq:
        return @"DBACmdIDCidDbaGetGroupMemberInfoReq";
    case DBACmdIDCidDbaGetGroupMemberInfoRsp:
        return @"DBACmdIDCidDbaGetGroupMemberInfoRsp";
    case DBACmdIDCidDbaAddMemberToGroupReq:
        return @"DBACmdIDCidDbaAddMemberToGroupReq";
    case DBACmdIDCidDbaAddMemberToGroupRsp:
        return @"DBACmdIDCidDbaAddMemberToGroupRsp";
    case DBACmdIDCidDbaRemoveMemberReq:
        return @"DBACmdIDCidDbaRemoveMemberReq";
    case DBACmdIDCidDbaRemoveMemberRsp:
        return @"DBACmdIDCidDbaRemoveMemberRsp";
    case DBACmdIDCidDbaModifyMemberInfoReq:
        return @"DBACmdIDCidDbaModifyMemberInfoReq";
    case DBACmdIDCidDbaModifyMemberInfoRsp:
        return @"DBACmdIDCidDbaModifyMemberInfoRsp";
    case DBACmdIDCidDbaGetUserPriorityReq:
        return @"DBACmdIDCidDbaGetUserPriorityReq";
    case DBACmdIDCidDbaGetUserPriorityRsp:
        return @"DBACmdIDCidDbaGetUserPriorityRsp";
    case DBACmdIDCidDbaSavePushMsg:
        return @"DBACmdIDCidDbaSavePushMsg";
    case DBACmdIDCidDbaSavePushMsgAck:
        return @"DBACmdIDCidDbaSavePushMsgAck";
    case DBACmdIDCidDbaSavePushMsgRela:
        return @"DBACmdIDCidDbaSavePushMsgRela";
    case DBACmdIDCidDbaSavePushMsgRelaAck:
        return @"DBACmdIDCidDbaSavePushMsgRelaAck";
    case DBACmdIDCidDbaRecvPushMsg:
        return @"DBACmdIDCidDbaRecvPushMsg";
    case DBACmdIDCidDbaRecvPushMsgAck:
        return @"DBACmdIDCidDbaRecvPushMsgAck";
    default:
        return nil;
    }
}
...
{
    switch (value) {
    case ApnsServiceCmdIDCidApnsPushReq:
    case ApnsServiceCmdIDCidApnsPushRsp:
        return YES;
    default:
        return NO;
    }
...
NSString* NSStringFromApnsServiceCmdID(ApnsServiceCmdID value)
{
    switch (value) {
    case ApnsServiceCmdIDCidApnsPushReq:
        return @"ApnsServiceCmdIDCidApnsPushReq";
    case ApnsServiceCmdIDCidApnsPushRsp:
        return @"ApnsServiceCmdIDCidApnsPushRsp";
    default:
        return nil;
    }
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasIp == otherMessage.hasIp && (!self.hasIp || [self.ip isEqual:otherMessage.ip]) && self.hasPort == otherMessage.hasPort && (!self.hasPort || self.port == otherMessage.port) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
@interface ErrorInfo ()
@property UInt32 ret;
@property (strong) NSData* strinfo;
@end
...
- (void)setHasStrinfo:(BOOL)_value_
{
    hasStrinfo_ = !!_value_;
}
...
- (instancetype)init
{
    if ((self = [super init])) {
        self.ret = 0;
        self.strinfo = [NSData data];
    }
    return self;
}

static ErrorInfo* defaultErrorInfoInstance = nil;
+ (void)initialize
{
    if (self == [ErrorInfo class]) {
        defaultErrorInfoInstance = [[ErrorInfo alloc] init];
    }
}

+ (instancetype)defaultInstance
{
    return defaultErrorInfoInstance;
}
...
{
    if (self.hasRet) {
        [output writeUInt32:1 value:self.ret];
    }
    if (self.hasStrinfo) {
        [output writeData:2 value:self.strinfo];
    }
    [self.unknownFields writeToCodedOutputStream:output];
}
...
- (SInt32)serializedSize
{
    ...
    size_ = 0;
    if (self.hasRet) {
        size_ += computeUInt32Size(1, self.ret);
    }
    if (self.hasStrinfo) {
        size_ += computeDataSize(2, self.strinfo);
    }
    size_ += self.unknownFields.serializedSize;
    memoizedSerializedSize = size_;
    return size_;
...
{
    return (ErrorInfo*)[[[ErrorInfo builder] mergeFromData:data] build];
}

+ (ErrorInfo*)parseFromData:(NSData*)data extensionRegistry:(PBExtensionRegistry*)extensionRegistry
{
    return (ErrorInfo*)[[[ErrorInfo builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}

+ (ErrorInfo*)parseFromInputStream:(NSInputStream*)input
{
    return (ErrorInfo*)[[[ErrorInfo builder] mergeFromInputStream:input] build];
}

+ (ErrorInfo*)parseFromInputStream:(NSInputStream*)input extensionRegistry:(PBExtensionRegistry*)extensionRegistry
{
    return (ErrorInfo*)[[[ErrorInfo builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}

+ (ErrorInfo*)parseFromCodedInputStream:(PBCodedInputStream*)input
{
    return (ErrorInfo*)[[[ErrorInfo builder] mergeFromCodedInputStream:input] build];
}

+ (ErrorInfo*)parseFromCodedInputStream:(PBCodedInputStream*)input extensionRegistry:(PBExtensionRegistry*)extensionRegistry
{
    return (ErrorInfo*)[[[ErrorInfo builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}

+ (ErrorInfoBuilder*)builder
{
    return [[ErrorInfoBuilder alloc] init];
}

+ (ErrorInfoBuilder*)builderWithPrototype:(ErrorInfo*)prototype
{
    return [[ErrorInfo builder] mergeFrom:prototype];
}
...
{
    return [ErrorInfo builderWithPrototype:self];
}
...
- (void)storeInDictionary:(NSMutableDictionary*)dictionary
{
    ...
    if (self.hasStrinfo) {
        [dictionary setObject:self.strinfo forKey:@"strinfo"];
    }
    [self.unknownFields storeInDictionary:dictionary];
}
...
- (BOOL)isEqual:(id)other
{
    ...
    if (![other isKindOfClass:[ErrorInfo class]]) {
        return NO;
    }
    ErrorInfo* otherMessage = other;
    return self.hasRet == otherMessage.hasRet && (!self.hasRet || self.ret == otherMessage.ret) && self.hasStrinfo == otherMessage.hasStrinfo && (!self.hasStrinfo || [self.strinfo isEqual:otherMessage.strinfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (NSUInteger)hash
{
    ...
    if (self.hasStrinfo) {
        hashCode = hashCode * 31 + [self.strinfo hash];
    }
    hashCode = hashCode * 31 + [self.unknownFields hash];
    return hashCode;
}
...
@interface ErrorInfoBuilder ()
@property (strong) ErrorInfo* resultErrorInfo;
@end

@implementation ErrorInfoBuilder
@synthesize resultErrorInfo;
- (instancetype)init
{
    if ((self = [super init])) {
        self.resultErrorInfo = [[ErrorInfo alloc] init];
    }
    return self;
}
...
{
    return [ErrorInfo builderWithPrototype:resultErrorInfo];
}
...
{
    ErrorInfo* returnMe = resultErrorInfo;
    self.resultErrorInfo = nil;
    return returnMe;
}
...
- (ErrorInfoBuilder*)mergeFromCodedInputStream:(PBCodedInputStream*)input extensionRegistry:(PBExtensionRegistry*)extensionRegistry
{
    ...
    while (YES) {
        ...
        case 8: {
            [self setRet:[input readUInt32]];
            break;
        }
        case 18: {
            [self setStrinfo:[input readData]];
            break;
        }
        }
    }
...
- (BOOL)hasRet
{
    return resultErrorInfo.hasRet;
}

- (UInt32)ret
{
    return resultErrorInfo.ret;
}

- (ErrorInfoBuilder*)setRet:(UInt32)value
{
    resultErrorInfo.hasRet = YES;
    resultErrorInfo.ret = value;
    return self;
}

- (ErrorInfoBuilder*)clearRet
{
    resultErrorInfo.hasRet = NO;
    resultErrorInfo.ret = 0;
    return self;
}

- (BOOL)hasStrinfo
{
    return resultErrorInfo.hasStrinfo;
}

- (NSData*)strinfo
{
    return resultErrorInfo.strinfo;
}

- (ErrorInfoBuilder*)setStrinfo:(NSData*)value
{
    resultErrorInfo.hasStrinfo = YES;
    resultErrorInfo.strinfo = value;
    return self;
}

- (ErrorInfoBuilder*)clearStrinfo
{
    resultErrorInfo.hasStrinfo = NO;
    resultErrorInfo.strinfo = [NSData data];
    return self;
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUserId == otherMessage.hasUserId && (!self.hasUserId || self.userId == otherMessage.userId) && self.hasUserGender == otherMessage.hasUserGender && (!self.hasUserGender || self.userGender == otherMessage.userGender) && self.hasUserNickName == otherMessage.hasUserNickName && (!self.hasUserNickName || [self.userNickName isEqual:otherMessage.userNickName]) && self.hasAvatarUrl == otherMessage.hasAvatarUrl && (!self.hasAvatarUrl || [self.avatarUrl isEqual:otherMessage.avatarUrl]) && self.hasDepartmentId == otherMessage.hasDepartmentId && (!self.hasDepartmentId || self.departmentId == otherMessage.departmentId) && self.hasEmail == otherMessage.hasEmail && (!self.hasEmail || [self.email isEqual:otherMessage.email]) && self.hasUserRealName == otherMessage.hasUserRealName && (!self.hasUserRealName || [self.userRealName isEqual:otherMessage.userRealName]) && self.hasUserTel == otherMessage.hasUserTel && (!self.hasUserTel || [self.userTel isEqual:otherMessage.userTel]) && self.hasUserDomain == otherMessage.hasUserDomain && (!self.hasUserDomain || [self.userDomain isEqual:otherMessage.userDomain]) && self.hasStatus == otherMessage.hasStatus && (!self.hasStatus || self.status == otherMessage.status) && self.hasSignInfo == otherMessage.hasSignInfo && (!self.hasSignInfo || [self.signInfo isEqual:otherMessage.signInfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasSessionId == otherMessage.hasSessionId && (!self.hasSessionId || self.sessionId == otherMessage.sessionId) && self.hasSessionType == otherMessage.hasSessionType && (!self.hasSessionType || self.sessionType == otherMessage.sessionType) && self.hasSessionStatus == otherMessage.hasSessionStatus && (!self.hasSessionStatus || self.sessionStatus == otherMessage.sessionStatus) && self.hasUpdatedTime == otherMessage.hasUpdatedTime && (!self.hasUpdatedTime || self.updatedTime == otherMessage.updatedTime) && self.hasLatestMsgId == otherMessage.hasLatestMsgId && (!self.hasLatestMsgId || self.latestMsgId == otherMessage.latestMsgId) && self.hasLatestMsgData == otherMessage.hasLatestMsgData && (!self.hasLatestMsgData || [self.latestMsgData isEqual:otherMessage.latestMsgData]) && self.hasLatestMsgType == otherMessage.hasLatestMsgType && (!self.hasLatestMsgType || self.latestMsgType == otherMessage.latestMsgType) && self.hasLatestMsgFromUserId == otherMessage.hasLatestMsgFromUserId && (!self.hasLatestMsgFromUserId || self.latestMsgFromUserId == otherMessage.latestMsgFromUserId) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUserId == otherMessage.hasUserId && (!self.hasUserId || self.userId == otherMessage.userId) && self.hasStatus == otherMessage.hasStatus && (!self.hasStatus || self.status == otherMessage.status) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUserId == otherMessage.hasUserId && (!self.hasUserId || self.userId == otherMessage.userId) && self.hasStatus == otherMessage.hasStatus && (!self.hasStatus || self.status == otherMessage.status) && self.hasClientType == otherMessage.hasClientType && (!self.hasClientType || self.clientType == otherMessage.clientType) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasSessionId == otherMessage.hasSessionId && (!self.hasSessionId || self.sessionId == otherMessage.sessionId) && self.hasSessionType == otherMessage.hasSessionType && (!self.hasSessionType || self.sessionType == otherMessage.sessionType) && self.hasUnreadCnt == otherMessage.hasUnreadCnt && (!self.hasUnreadCnt || self.unreadCnt == otherMessage.unreadCnt) && self.hasLatestMsgId == otherMessage.hasLatestMsgId && (!self.hasLatestMsgId || self.latestMsgId == otherMessage.latestMsgId) && self.hasLatestMsgData == otherMessage.hasLatestMsgData && (!self.hasLatestMsgData || [self.latestMsgData isEqual:otherMessage.latestMsgData]) && self.hasLatestMsgType == otherMessage.hasLatestMsgType && (!self.hasLatestMsgType || self.latestMsgType == otherMessage.latestMsgType) && self.hasLatestMsgFromUserId == otherMessage.hasLatestMsgFromUserId && (!self.hasLatestMsgFromUserId || self.latestMsgFromUserId == otherMessage.latestMsgFromUserId) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasMsgId == otherMessage.hasMsgId && (!self.hasMsgId || self.msgId == otherMessage.msgId) && self.hasFromSessionId == otherMessage.hasFromSessionId && (!self.hasFromSessionId || self.fromSessionId == otherMessage.fromSessionId) && self.hasCreateTime == otherMessage.hasCreateTime && (!self.hasCreateTime || self.createTime == otherMessage.createTime) && self.hasMsgType == otherMessage.hasMsgType && (!self.hasMsgType || self.msgType == otherMessage.msgType) && self.hasMsgData == otherMessage.hasMsgData && (!self.hasMsgData || [self.msgData isEqual:otherMessage.msgData]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasGroupId == otherMessage.hasGroupId && (!self.hasGroupId || self.groupId == otherMessage.groupId) && self.hasVersion == otherMessage.hasVersion && (!self.hasVersion || self.version == otherMessage.version) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasGroupId == otherMessage.hasGroupId && (!self.hasGroupId || self.groupId == otherMessage.groupId) && self.hasVersion == otherMessage.hasVersion && (!self.hasVersion || self.version == otherMessage.version) && self.hasGroupName == otherMessage.hasGroupName && (!self.hasGroupName || [self.groupName isEqual:otherMessage.groupName]) && self.hasGroupAvatar == otherMessage.hasGroupAvatar && (!self.hasGroupAvatar || [self.groupAvatar isEqual:otherMessage.groupAvatar]) && self.hasGroupCreatorId == otherMessage.hasGroupCreatorId && (!self.hasGroupCreatorId || self.groupCreatorId == otherMessage.groupCreatorId) && self.hasGroupType == otherMessage.hasGroupType && (!self.hasGroupType || self.groupType == otherMessage.groupType) && self.hasShieldStatus == otherMessage.hasShieldStatus && (!self.hasShieldStatus || self.shieldStatus == otherMessage.shieldStatus) &&
        [self.groupMemberListArray isEqualToArray:otherMessage.groupMemberListArray] && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUserId == otherMessage.hasUserId && (!self.hasUserId || self.userId == otherMessage.userId) && self.hasUserType == otherMessage.hasUserType && (!self.hasUserType || self.userType == otherMessage.userType) && self.hasToken == otherMessage.hasToken && (!self.hasToken || [self.token isEqual:otherMessage.token]) && self.hasPushCount == otherMessage.hasPushCount && (!self.hasPushCount || self.pushCount == otherMessage.pushCount) && self.hasPushType == otherMessage.hasPushType && (!self.hasPushType || self.pushType == otherMessage.pushType) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUserToken == otherMessage.hasUserToken && (!self.hasUserToken || [self.userToken isEqual:otherMessage.userToken]) && self.hasResultCode == otherMessage.hasResultCode && (!self.hasResultCode || self.resultCode == otherMessage.resultCode) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUserId == otherMessage.hasUserId && (!self.hasUserId || self.userId == otherMessage.userId) && self.hasGroupId == otherMessage.hasGroupId && (!self.hasGroupId || self.groupId == otherMessage.groupId) && self.hasShieldStatus == otherMessage.hasShieldStatus && (!self.hasShieldStatus || self.shieldStatus == otherMessage.shieldStatus) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasFromUserId == otherMessage.hasFromUserId && (!self.hasFromUserId || self.fromUserId == otherMessage.fromUserId) && self.hasTaskId == otherMessage.hasTaskId && (!self.hasTaskId || [self.taskId isEqual:otherMessage.taskId]) && self.hasFileName == otherMessage.hasFileName && (!self.hasFileName || [self.fileName isEqual:otherMessage.fileName]) && self.hasFileSize == otherMessage.hasFileSize && (!self.hasFileSize || self.fileSize == otherMessage.fileSize) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasDeptId == otherMessage.hasDeptId && (!self.hasDeptId || self.deptId == otherMessage.deptId) && self.hasPriority == otherMessage.hasPriority && (!self.hasPriority || self.priority == otherMessage.priority) && self.hasDeptName == otherMessage.hasDeptName && (!self.hasDeptName || [self.deptName isEqual:otherMessage.deptName]) && self.hasParentDeptId == otherMessage.hasParentDeptId && (!self.hasParentDeptId || self.parentDeptId == otherMessage.parentDeptId) && self.hasDeptStatus == otherMessage.hasDeptStatus && (!self.hasDeptStatus || self.deptStatus == otherMessage.deptStatus) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUserId == otherMessage.hasUserId && (!self.hasUserId || self.userId == otherMessage.userId) && self.hasShieldStatus == otherMessage.hasShieldStatus && (!self.hasShieldStatus || self.shieldStatus == otherMessage.shieldStatus) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (void)setHasServerip:(BOOL)_value_
{
    hasServerip_ = !!_value_;
}
...
- (void)setHasServerport:(BOOL)_value_
{
    hasServerport_ = !!_value_;
}
...
{
    if ((self = [super init])) {
        self.serverid = ServerIDServerStatus;
        self.serverip = @"";
        self.serverport = 0;
    }
    return self;
...
static ClientRegReq* defaultClientRegReqInstance = nil;
+ (void)initialize
{
    if (self == [ClientRegReq class]) {
        defaultClientRegReqInstance = [[ClientRegReq alloc] init];
    }
}

+ (instancetype)defaultInstance
{
    return defaultClientRegReqInstance;
}
...
{
    if (self.hasServerid) {
        [output writeEnum:1 value:self.serverid];
    }
    if (self.hasServerip) {
        [output writeString:2 value:self.serverip];
    }
...
- (SInt32)serializedSize
{
    ...
    size_ = 0;
    if (self.hasServerid) {
        size_ += computeEnumSize(1, self.serverid);
    }
    if (self.hasServerip) {
        size_ += computeStringSize(2, self.serverip);
    }
    if (self.hasServerport) {
...
{
    return (ClientRegReq*)[[[ClientRegReq builder] mergeFromData:data] build];
}

+ (ClientRegReq*)parseFromData:(NSData*)data extensionRegistry:(PBExtensionRegistry*)extensionRegistry
{
    return (ClientRegReq*)[[[ClientRegReq builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}

+ (ClientRegReq*)parseFromInputStream:(NSInputStream*)input
{
    return (ClientRegReq*)[[[ClientRegReq builder] mergeFromInputStream:input] build];
}

+ (ClientRegReq*)parseFromInputStream:(NSInputStream*)input extensionRegistry:(PBExtensionRegistry*)extensionRegistry
{
    return (ClientRegReq*)[[[ClientRegReq builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}

+ (ClientRegReq*)parseFromCodedInputStream:(PBCodedInputStream*)input
{
    return (ClientRegReq*)[[[ClientRegReq builder] mergeFromCodedInputStream:input] build];
}

+ (ClientRegReq*)parseFromCodedInputStream:(PBCodedInputStream*)input extensionRegistry:(PBExtensionRegistry*)extensionRegistry
{
    return (ClientRegReq*)[[[ClientRegReq builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}

+ (ClientRegReqBuilder*)builder
{
    return [[ClientRegReqBuilder alloc] init];
}

+ (ClientRegReqBuilder*)builderWithPrototype:(ClientRegReq*)prototype
{
    return [[ClientRegReq builder] mergeFrom:prototype];
}

- (ClientRegReqBuilder*)builder
{
    return [ClientRegReq builder];
}

- (ClientRegReqBuilder*)toBuilder
{
    return [ClientRegReq builderWithPrototype:self];
}

- (void)writeDescriptionTo:(NSMutableString*)output withIndent:(NSString*)indent
{
    if (self.hasServerid) {
        [output appendFormat:@"%@%@: %@\n", indent, @"serverid", NSStringFromServerID(self.serverid)];
    }
    if (self.hasServerip) {
        [output appendFormat:@"%@%@: %@\n", indent, @"serverip", self.serverip];
    }
    if (self.hasServerport) {
        [output appendFormat:@"%@%@: %@\n", indent, @"serverport", [NSNumber numberWithInteger:self.serverport]];
    }
    [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
...
{
    if (self.hasServerid) {
        [dictionary setObject:@(self.serverid) forKey:@"serverid"];
    }
    if (self.hasServerip) {
        [dictionary setObject:self.serverip forKey:@"serverip"];
    }
    if (self.hasServerport) {
        [dictionary setObject:[NSNumber numberWithInteger:self.serverport] forKey:@"serverport"];
    }
    [self.unknownFields storeInDictionary:dictionary];
}
...
- (BOOL)isEqual:(id)other
{
    ...
    if (![other isKindOfClass:[ClientRegReq class]]) {
        return NO;
    }
    ClientRegReq* otherMessage = other;
    return self.hasServerid == otherMessage.hasServerid && (!self.hasServerid || self.serverid == otherMessage.serverid) && self.hasServerip == otherMessage.hasServerip && (!self.hasServerip || [self.serverip isEqual:otherMessage.serverip]) && self.hasServerport == otherMessage.hasServerport && (!self.hasServerport || self.serverport == otherMessage.serverport) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (NSUInteger)hash
{
    __block NSUInteger hashCode = 7;
    if (self.hasServerid) {
        hashCode = hashCode * 31 + self.serverid;
    }
    if (self.hasServerip) {
        hashCode = hashCode * 31 + [self.serverip hash];
    }
    if (self.hasServerport) {
        hashCode = hashCode * 31 + [[NSNumber numberWithInteger:self.serverport] hash];
    }
    hashCode = hashCode * 31 + [self.unknownFields hash];
    return hashCode;
}
...
@interface ClientRegReqBuilder ()
@property (strong) ClientRegReq* resultClientRegReq;
@end

@implementation ClientRegReqBuilder
@synthesize resultClientRegReq;
- (instancetype)init
{
    if ((self = [super init])) {
        self.resultClientRegReq = [[ClientRegReq alloc] init];
    }
    return self;
}
...
{
    return [ClientRegReq builderWithPrototype:resultClientRegReq];
}

- (ClientRegReq*)defaultInstance
{
    return [ClientRegReq defaultInstance];
}
...
{
    ClientRegReq* returnMe = resultClientRegReq;
    self.resultClientRegReq = nil;
    return returnMe;
}

- (ClientRegReqBuilder*)mergeFrom:(ClientRegReq*)other
{
    if (other == [ClientRegReq defaultInstance]) {
        return self;
    }
...
- (ClientRegReqBuilder*)mergeFromCodedInputStream:(PBCodedInputStream*)input extensionRegistry:(PBExtensionRegistry*)extensionRegistry
{
    ...
    while (YES) {
        ...
        case 8: {
            ServerID value = (ServerID)[input readEnum];
            if (ServerIDIsValidValue(value)) {
                [self setServerid:value];
            }
            else {
        ...
        case 18: {
            [self setServerip:[input readString]];
            break;
        }
        case 24: {
...
- (BOOL)hasServerid
{
    return resultClientRegReq.hasServerid;
}

- (ServerID)serverid
{
    return resultClientRegReq.serverid;
}

- (ClientRegReqBuilder*)setServerid:(ServerID)value
{
    resultClientRegReq.hasServerid = YES;
    resultClientRegReq.serverid = value;
    return self;
}

- (ClientRegReqBuilder*)clearServerid
{
    resultClientRegReq.hasServerid = NO;
    resultClientRegReq.serverid = ServerIDServerStatus;
    return self;
}

- (BOOL)hasServerip
{
    return resultClientRegReq.hasServerip;
}

- (NSString*)serverip
{
    return resultClientRegReq.serverip;
}

- (ClientRegReqBuilder*)setServerip:(NSString*)value
{
    resultClientRegReq.hasServerip = YES;
    resultClientRegReq.serverip = value;
    return self;
}

- (ClientRegReqBuilder*)clearServerip
{
    resultClientRegReq.hasServerip = NO;
    resultClientRegReq.serverip = @"";
    return self;
}

- (BOOL)hasServerport
{
    return resultClientRegReq.hasServerport;
}

- (UInt32)serverport
{
    return resultClientRegReq.serverport;
}

- (ClientRegReqBuilder*)setServerport:(UInt32)value
{
    resultClientRegReq.hasServerport = YES;
    resultClientRegReq.serverport = value;
    return self;
}

- (ClientRegReqBuilder*)clearServerport
{
    resultClientRegReq.hasServerport = NO;
    resultClientRegReq.serverport = 0;
    return self;
}

@end

@interface ClientRegRsp ()
@property (strong) ErrorInfo* errinfo;
@end

@implementation ClientRegRsp
...
- (void)setHasErrinfo:(BOOL)_value_
{
    hasErrinfo_ = !!_value_;
}
...
{
    if ((self = [super init])) {
        self.errinfo = [ErrorInfo defaultInstance];
    }
    return self;
}

static ClientRegRsp* defaultClientRegRspInstance = nil;
+ (void)initialize
{
    if (self == [ClientRegRsp class]) {
        defaultClientRegRspInstance = [[ClientRegRsp alloc] init];
    }
}

+ (instancetype)defaultInstance
{
    return defaultClientRegRspInstance;
}
...
{
    if (self.hasErrinfo) {
        [output writeMessage:1 value:self.errinfo];
    }
    [self.unknownFields writeToCodedOutputStream:output];
}
...
- (SInt32)serializedSize
{
    ...
    size_ = 0;
    if (self.hasErrinfo) {
        size_ += computeMessageSize(1, self.errinfo);
    }
    size_ += self.unknownFields.serializedSize;
    memoizedSerializedSize = size_;
    return size_;
...
{
    return (ClientRegRsp*)[[[ClientRegRsp builder] mergeFromData:data] build];
}

+ (ClientRegRsp*)parseFromData:(NSData*)data extensionRegistry:(PBExtensionRegistry*)extensionRegistry
{
    return (ClientRegRsp*)[[[ClientRegRsp builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}

+ (ClientRegRsp*)parseFromInputStream:(NSInputStream*)input
{
    return (ClientRegRsp*)[[[ClientRegRsp builder] mergeFromInputStream:input] build];
}

+ (ClientRegRsp*)parseFromInputStream:(NSInputStream*)input extensionRegistry:(PBExtensionRegistry*)extensionRegistry
{
    return (ClientRegRsp*)[[[ClientRegRsp builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}

+ (ClientRegRsp*)parseFromCodedInputStream:(PBCodedInputStream*)input
{
    return (ClientRegRsp*)[[[ClientRegRsp builder] mergeFromCodedInputStream:input] build];
}

+ (ClientRegRsp*)parseFromCodedInputStream:(PBCodedInputStream*)input extensionRegistry:(PBExtensionRegistry*)extensionRegistry
{
    return (ClientRegRsp*)[[[ClientRegRsp builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}

+ (ClientRegRspBuilder*)builder
{
    return [[ClientRegRspBuilder alloc] init];
}

+ (ClientRegRspBuilder*)builderWithPrototype:(ClientRegRsp*)prototype
{
    return [[ClientRegRsp builder] mergeFrom:prototype];
}

- (ClientRegRspBuilder*)builder
{
    return [ClientRegRsp builder];
}

- (ClientRegRspBuilder*)toBuilder
{
    return [ClientRegRsp builderWithPrototype:self];
}
...
- (void)writeDescriptionTo:(NSMutableString*)output withIndent:(NSString*)indent
{
    if (self.hasErrinfo) {
        [output appendFormat:@"%@%@ {\n", indent, @"errinfo"];
        [self.errinfo writeDescriptionTo:output
...
- (void)storeInDictionary:(NSMutableDictionary*)dictionary
{
    if (self.hasErrinfo) {
        ...
        [self.errinfo storeInDictionary:messageDictionary];
        [dictionary setObject:[NSDictionary dictionaryWithDictionary:messageDictionary] forKey:@"errinfo"];
    }
    [self.unknownFields storeInDictionary:dictionary];
}
...
- (BOOL)isEqual:(id)other
{
    ...
    if (![other isKindOfClass:[ClientRegRsp class]]) {
        return NO;
    }
    ClientRegRsp* otherMessage = other;
    return self.hasErrinfo == otherMessage.hasErrinfo && (!self.hasErrinfo || [self.errinfo isEqual:otherMessage.errinfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (NSUInteger)hash
{
    __block NSUInteger hashCode = 7;
    if (self.hasErrinfo) {
        hashCode = hashCode * 31 + [self.errinfo hash];
    }
    hashCode = hashCode * 31 + [self.unknownFields hash];
    return hashCode;
}
...
@interface ClientRegRspBuilder ()
@property (strong) ClientRegRsp* resultClientRegRsp;
@end

@implementation ClientRegRspBuilder
@synthesize resultClientRegRsp;
- (instancetype)init
{
    if ((self = [super init])) {
        self.resultClientRegRsp = [[ClientRegRsp alloc] init];
    }
    return self;
}
...
{
    return [ClientRegRsp builderWithPrototype:resultClientRegRsp];
}

- (ClientRegRsp*)defaultInstance
{
    return [ClientRegRsp defaultInstance];
}
...
{
    ClientRegRsp* returnMe = resultClientRegRsp;
    self.resultClientRegRsp = nil;
    return returnMe;
}

- (ClientRegRspBuilder*)mergeFrom:(ClientRegRsp*)other
{
    if (other == [ClientRegRsp defaultInstance]) {
        return self;
    }
    if (other.hasErrinfo) {
        [self mergeErrinfo:other.errinfo];
    }
    [self mergeUnknownFields:other.unknownFields];
    return self;
}
...
- (ClientRegRspBuilder*)mergeFromCodedInputStream:(PBCodedInputStream*)input extensionRegistry:(PBExtensionRegistry*)extensionRegistry
{
    ...
    while (YES) {
        ...
        case 10: {
            ...
            if (self.hasErrinfo) {
                [subBuilder mergeFrom:self.errinfo];
            }
            [input readMessage:subBuilder extensionRegistry:extensionRegistry];
            [self setErrinfo:[subBuilder buildPartial]];
            break;
        }
        }
    }
...
- (BOOL)hasErrinfo
{
    return resultClientRegRsp.hasErrinfo;
}

- (ErrorInfo*)errinfo
{
    return resultClientRegRsp.errinfo;
}

- (ClientRegRspBuilder*)setErrinfo:(ErrorInfo*)value
{
    resultClientRegRsp.hasErrinfo = YES;
    resultClientRegRsp.errinfo = value;
    return self;
}

- (ClientRegRspBuilder*)setErrinfoBuilder:(ErrorInfoBuilder*)builderForValue
{
    return [self setErrinfo:[builderForValue build]];
}

- (ClientRegRspBuilder*)mergeErrinfo:(ErrorInfo*)value
{
    if (resultClientRegRsp.hasErrinfo && resultClientRegRsp.errinfo != [ErrorInfo defaultInstance]) {
        resultClientRegRsp.errinfo =
            [[[ErrorInfo builderWithPrototype:resultClientRegRsp.errinfo] mergeFrom:value] buildPartial];
    }
    else {
        resultClientRegRsp.errinfo = value;
    }
...
{
    resultClientRegRsp.hasErrinfo = NO;
    resultClientRegRsp.errinfo = [ErrorInfo defaultInstance];
    return self;
}
