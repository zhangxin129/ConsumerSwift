...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasType == otherMessage.hasType && (!self.hasType || self.type == otherMessage.type) && self.hasChatmsg == otherMessage.hasChatmsg && (!self.hasChatmsg || [self.chatmsg isEqual:otherMessage.chatmsg]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
{
    if (resultMessage.hasChatmsg && resultMessage.chatmsg != [ChatMsg defaultInstance]) {
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasType == otherMessage.hasType && (!self.hasType || self.type == otherMessage.type) && self.hasAddbuddy == otherMessage.hasAddbuddy && (!self.hasAddbuddy || [self.addbuddy isEqual:otherMessage.addbuddy]) && self.hasBuddyVerify == otherMessage.hasBuddyVerify && (!self.hasBuddyVerify || [self.buddyVerify isEqual:otherMessage.buddyVerify]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
{
    if (resultSysMessage.hasAddbuddy && resultSysMessage.addbuddy != [AddBuddy defaultInstance]) {
...
{
    if (resultSysMessage.hasBuddyVerify && resultSysMessage.buddyVerify != [BuddyVerify defaultInstance]) {
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasSubGroupId == otherMessage.hasSubGroupId && (!self.hasSubGroupId || self.subGroupId == otherMessage.subGroupId) && self.hasSubGroupName == otherMessage.hasSubGroupName && (!self.hasSubGroupName || [self.subGroupName isEqual:otherMessage.subGroupName]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasBuddyId == otherMessage.hasBuddyId && (!self.hasBuddyId || self.buddyId == otherMessage.buddyId) && self.hasNickname == otherMessage.hasNickname && (!self.hasNickname || [self.nickname isEqual:otherMessage.nickname]) && self.hasGender == otherMessage.hasGender && (!self.hasGender || self.gender == otherMessage.gender) && self.hasAvatar == otherMessage.hasAvatar && (!self.hasAvatar || [self.avatar isEqual:otherMessage.avatar]) && self.hasSubGroupId == otherMessage.hasSubGroupId && (!self.hasSubGroupId || self.subGroupId == otherMessage.subGroupId) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUid == otherMessage.hasUid && (!self.hasUid || self.uid == otherMessage.uid) && self.hasPageSize == otherMessage.hasPageSize && (!self.hasPageSize || self.pageSize == otherMessage.pageSize) && self.hasPageId == otherMessage.hasPageId && (!self.hasPageId || self.pageId == otherMessage.pageId) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasType == otherMessage.hasType && (!self.hasType || self.type == otherMessage.type) && self.hasUnreads == otherMessage.hasUnreads && (!self.hasUnreads || self.unreads == otherMessage.unreads) && self.hasCurMsgId == otherMessage.hasCurMsgId && (!self.hasCurMsgId || self.curMsgId == otherMessage.curMsgId) && self.hasCurMsgContent == otherMessage.hasCurMsgContent && (!self.hasCurMsgContent || [self.curMsgContent isEqual:otherMessage.curMsgContent]) && self.hasCurMsgTime == otherMessage.hasCurMsgTime && (!self.hasCurMsgTime || self.curMsgTime == otherMessage.curMsgTime) && self.hasBuddyInfo == otherMessage.hasBuddyInfo && (!self.hasBuddyInfo || [self.buddyInfo isEqual:otherMessage.buddyInfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
{
    if (resultRecentMessage.hasBuddyInfo && resultRecentMessage.buddyInfo != [Buddy defaultInstance]) {
...
- (BOOL)isInitialized
{
    ...
    if (!isInitrecentMsgList)
        return isInitrecentMsgList;
    return YES;
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return
        [self.recentMsgListArray isEqualToArray:otherMessage.recentMsgListArray] && self.hasRet == otherMessage.hasRet && (!self.hasRet || self.ret == otherMessage.ret) && self.hasErrorInfo == otherMessage.hasErrorInfo && (!self.hasErrorInfo || [self.errorInfo isEqual:otherMessage.errorInfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUid == otherMessage.hasUid && (!self.hasUid || self.uid == otherMessage.uid) && self.hasMethod == otherMessage.hasMethod && (!self.hasMethod || self.method == otherMessage.method) && self.hasBuddyUid == otherMessage.hasBuddyUid && (!self.hasBuddyUid || self.buddyUid == otherMessage.buddyUid) && self.hasGroupId == otherMessage.hasGroupId && (!self.hasGroupId || self.groupId == otherMessage.groupId) && self.hasPullStart == otherMessage.hasPullStart && (!self.hasPullStart || self.pullStart == otherMessage.pullStart) && self.hasPullCount == otherMessage.hasPullCount && (!self.hasPullCount || self.pullCount == otherMessage.pullCount) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasType == otherMessage.hasType && (!self.hasType || self.type == otherMessage.type) &&
        [self.msgListArray isEqualToArray:otherMessage.msgListArray] && self.hasRet == otherMessage.hasRet && (!self.hasRet || self.ret == otherMessage.ret) && self.hasErrorInfo == otherMessage.hasErrorInfo && (!self.hasErrorInfo || [self.errorInfo isEqual:otherMessage.errorInfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUid == otherMessage.hasUid && (!self.hasUid || self.uid == otherMessage.uid) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isInitialized
{
    ...
    if (!isInitsubGroupList)
        return isInitsubGroupList;
    return YES;
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUid == otherMessage.hasUid && (!self.hasUid || self.uid == otherMessage.uid) &&
        [self.subGroupListArray isEqualToArray:otherMessage.subGroupListArray] && self.hasRet == otherMessage.hasRet && (!self.hasRet || self.ret == otherMessage.ret) && self.hasErrorInfo == otherMessage.hasErrorInfo && (!self.hasErrorInfo || [self.errorInfo isEqual:otherMessage.errorInfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUid == otherMessage.hasUid && (!self.hasUid || self.uid == otherMessage.uid) && self.hasDeviceType == otherMessage.hasDeviceType && (!self.hasDeviceType || self.deviceType == otherMessage.deviceType) && self.hasSubGroupId == otherMessage.hasSubGroupId && (!self.hasSubGroupId || self.subGroupId == otherMessage.subGroupId) && self.hasPageSize == otherMessage.hasPageSize && (!self.hasPageSize || self.pageSize == otherMessage.pageSize) && self.hasPageId == otherMessage.hasPageId && (!self.hasPageId || self.pageId == otherMessage.pageId) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return
        [self.buddyListArray isEqualToArray:otherMessage.buddyListArray] && self.hasRet == otherMessage.hasRet && (!self.hasRet || self.ret == otherMessage.ret) && self.hasErrorInfo == otherMessage.hasErrorInfo && (!self.hasErrorInfo || [self.errorInfo isEqual:otherMessage.errorInfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasFromUid == otherMessage.hasFromUid && (!self.hasFromUid || self.fromUid == otherMessage.fromUid) && self.hasFromNickName == otherMessage.hasFromNickName && (!self.hasFromNickName || [self.fromNickName isEqual:otherMessage.fromNickName]) && self.hasFromGender == otherMessage.hasFromGender && (!self.hasFromGender || self.fromGender == otherMessage.fromGender) && self.hasFromAvatar == otherMessage.hasFromAvatar && (!self.hasFromAvatar || [self.fromAvatar isEqual:otherMessage.fromAvatar]) && self.hasToUid == otherMessage.hasToUid && (!self.hasToUid || self.toUid == otherMessage.toUid) && self.hasToNickName == otherMessage.hasToNickName && (!self.hasToNickName || [self.toNickName isEqual:otherMessage.toNickName]) && self.hasToGender == otherMessage.hasToGender && (!self.hasToGender || self.toGender == otherMessage.toGender) && self.hasToAvatar == otherMessage.hasToAvatar && (!self.hasToAvatar || [self.toAvatar isEqual:otherMessage.toAvatar]) && self.hasMsgTime == otherMessage.hasMsgTime && (!self.hasMsgTime || self.msgTime == otherMessage.msgTime) && self.hasContent == otherMessage.hasContent && (!self.hasContent || [self.content isEqual:otherMessage.content]) && self.hasMsgId == otherMessage.hasMsgId && (!self.hasMsgId || self.msgId == otherMessage.msgId) && self.hasDeviceType == otherMessage.hasDeviceType && (!self.hasDeviceType || self.deviceType == otherMessage.deviceType) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasMsgId == otherMessage.hasMsgId && (!self.hasMsgId || self.msgId == otherMessage.msgId) && self.hasRet == otherMessage.hasRet && (!self.hasRet || self.ret == otherMessage.ret) && self.hasErrorInfo == otherMessage.hasErrorInfo && (!self.hasErrorInfo || [self.errorInfo isEqual:otherMessage.errorInfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUid == otherMessage.hasUid && (!self.hasUid || self.uid == otherMessage.uid) && self.hasDeviceType == otherMessage.hasDeviceType && (!self.hasDeviceType || self.deviceType == otherMessage.deviceType) && self.hasType == otherMessage.hasType && (!self.hasType || self.type == otherMessage.type) && self.hasBuddyUid == otherMessage.hasBuddyUid && (!self.hasBuddyUid || self.buddyUid == otherMessage.buddyUid) && self.hasGroupId == otherMessage.hasGroupId && (!self.hasGroupId || self.groupId == otherMessage.groupId) && self.hasMsgId == otherMessage.hasMsgId && (!self.hasMsgId || self.msgId == otherMessage.msgId) && self.hasRet == otherMessage.hasRet && (!self.hasRet || self.ret == otherMessage.ret) && self.hasErrorInfo == otherMessage.hasErrorInfo && (!self.hasErrorInfo || [self.errorInfo isEqual:otherMessage.errorInfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUid == otherMessage.hasUid && (!self.hasUid || self.uid == otherMessage.uid) && self.hasMethod == otherMessage.hasMethod && (!self.hasMethod || self.method == otherMessage.method) && self.hasSubGroupId == otherMessage.hasSubGroupId && (!self.hasSubGroupId || self.subGroupId == otherMessage.subGroupId) && self.hasSubGroupName == otherMessage.hasSubGroupName && (!self.hasSubGroupName || [self.subGroupName isEqual:otherMessage.subGroupName]) && self.hasMoveTo == otherMessage.hasMoveTo && (!self.hasMoveTo || self.moveTo == otherMessage.moveTo) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasRet == otherMessage.hasRet && (!self.hasRet || self.ret == otherMessage.ret) && self.hasErrorInfo == otherMessage.hasErrorInfo && (!self.hasErrorInfo || [self.errorInfo isEqual:otherMessage.errorInfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasRequesterId == otherMessage.hasRequesterId && (!self.hasRequesterId || self.requesterId == otherMessage.requesterId) && self.hasRequesterNickName == otherMessage.hasRequesterNickName && (!self.hasRequesterNickName || [self.requesterNickName isEqual:otherMessage.requesterNickName]) && self.hasRequesterGender == otherMessage.hasRequesterGender && (!self.hasRequesterGender || self.requesterGender == otherMessage.requesterGender) && self.hasRequesterAvatar == otherMessage.hasRequesterAvatar && (!self.hasRequesterAvatar || [self.requesterAvatar isEqual:otherMessage.requesterAvatar]) && self.hasBuddyUid == otherMessage.hasBuddyUid && (!self.hasBuddyUid || self.buddyUid == otherMessage.buddyUid) && self.hasMsgId == otherMessage.hasMsgId && (!self.hasMsgId || self.msgId == otherMessage.msgId) && self.hasVertifyContent == otherMessage.hasVertifyContent && (!self.hasVertifyContent || [self.vertifyContent isEqual:otherMessage.vertifyContent]) && self.hasSubGroupId == otherMessage.hasSubGroupId && (!self.hasSubGroupId || self.subGroupId == otherMessage.subGroupId) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasResponserId == otherMessage.hasResponserId && (!self.hasResponserId || self.responserId == otherMessage.responserId) && self.hasResponserNickname == otherMessage.hasResponserNickname && (!self.hasResponserNickname || [self.responserNickname isEqual:otherMessage.responserNickname]) && self.hasResponserGender == otherMessage.hasResponserGender && (!self.hasResponserGender || self.responserGender == otherMessage.responserGender) && self.hasResponserAvatar == otherMessage.hasResponserAvatar && (!self.hasResponserAvatar || [self.responserAvatar isEqual:otherMessage.responserAvatar]) && self.hasBuddyUid == otherMessage.hasBuddyUid && (!self.hasBuddyUid || self.buddyUid == otherMessage.buddyUid) && self.hasMsgId == otherMessage.hasMsgId && (!self.hasMsgId || self.msgId == otherMessage.msgId) && self.hasAgree == otherMessage.hasAgree && (!self.hasAgree || self.agree == otherMessage.agree) && self.hasSubGruopId == otherMessage.hasSubGruopId && (!self.hasSubGruopId || self.subGruopId == otherMessage.subGruopId) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUid == otherMessage.hasUid && (!self.hasUid || self.uid == otherMessage.uid) && self.hasBuddyUid == otherMessage.hasBuddyUid && (!self.hasBuddyUid || self.buddyUid == otherMessage.buddyUid) && self.hasMethod == otherMessage.hasMethod && (!self.hasMethod || self.method == otherMessage.method) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isInitialized
{
    ...
    if (!isInitsystemMsgList)
        return isInitsystemMsgList;
    return YES;
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return
        [self.systemMsgListArray isEqualToArray:otherMessage.systemMsgListArray] && self.hasRet == otherMessage.hasRet && (!self.hasRet || self.ret == otherMessage.ret) && self.hasErrorInfo == otherMessage.hasErrorInfo && (!self.hasErrorInfo || [self.errorInfo isEqual:otherMessage.errorInfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasCstId == otherMessage.hasCstId && (!self.hasCstId || [self.cstId isEqual:otherMessage.cstId]) && self.hasLoginToken == otherMessage.hasLoginToken && (!self.hasLoginToken || [self.loginToken isEqual:otherMessage.loginToken]) && self.hasChannelType == otherMessage.hasChannelType && (!self.hasChannelType || self.channelType == otherMessage.channelType) && self.hasEntResNo == otherMessage.hasEntResNo && (!self.hasEntResNo || [self.entResNo isEqual:otherMessage.entResNo]) && self.hasStatus == otherMessage.hasStatus && (!self.hasStatus || self.status == otherMessage.status) && self.hasForceLogin == otherMessage.hasForceLogin && (!self.hasForceLogin || self.forceLogin == otherMessage.forceLogin) && self.hasDeviceType == otherMessage.hasDeviceType && (!self.hasDeviceType || self.deviceType == otherMessage.deviceType) && self.hasDeviceToken == otherMessage.hasDeviceToken && (!self.hasDeviceToken || [self.deviceToken isEqual:otherMessage.deviceToken]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUserId == otherMessage.hasUserId && (!self.hasUserId || self.userId == otherMessage.userId) && self.hasRet == otherMessage.hasRet && (!self.hasRet || self.ret == otherMessage.ret) && self.hasErrorInfo == otherMessage.hasErrorInfo && (!self.hasErrorInfo || [self.errorInfo isEqual:otherMessage.errorInfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUserId == otherMessage.hasUserId && (!self.hasUserId || self.userId == otherMessage.userId) && self.hasDeviceType == otherMessage.hasDeviceType && (!self.hasDeviceType || self.deviceType == otherMessage.deviceType) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasFromuid == otherMessage.hasFromuid && (!self.hasFromuid || self.fromuid == otherMessage.fromuid) && self.hasServerid == otherMessage.hasServerid && (!self.hasServerid || self.serverid == otherMessage.serverid) && self.hasMsgtype == otherMessage.hasMsgtype && (!self.hasMsgtype || self.msgtype == otherMessage.msgtype) && self.hasToid == otherMessage.hasToid && (!self.hasToid || self.toid == otherMessage.toid) && self.hasContent == otherMessage.hasContent && (!self.hasContent || [self.content isEqual:otherMessage.content]) && self.hasMsgid == otherMessage.hasMsgid && (!self.hasMsgid || self.msgid == otherMessage.msgid) && self.hasDevicetype == otherMessage.hasDevicetype && (!self.hasDevicetype || self.devicetype == otherMessage.devicetype) && self.hasMsgtime == otherMessage.hasMsgtime && (!self.hasMsgtime || self.msgtime == otherMessage.msgtime) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUserId == otherMessage.hasUserId && (!self.hasUserId || self.userId == otherMessage.userId) && self.hasPlantformId == otherMessage.hasPlantformId && (!self.hasPlantformId || self.plantformId == otherMessage.plantformId) && self.hasMsgId == otherMessage.hasMsgId && (!self.hasMsgId || self.msgId == otherMessage.msgId) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUnreads == otherMessage.hasUnreads && (!self.hasUnreads || self.unreads == otherMessage.unreads) && self.hasPlantformId == otherMessage.hasPlantformId && (!self.hasPlantformId || self.plantformId == otherMessage.plantformId) && self.hasMsgId == otherMessage.hasMsgId && (!self.hasMsgId || self.msgId == otherMessage.msgId) && self.hasContent == otherMessage.hasContent && (!self.hasContent || [self.content isEqual:otherMessage.content]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
- (BOOL)isEqual:(id)other
{
    ...
    return
        [self.msgListArray isEqualToArray:otherMessage.msgListArray] && self.hasErrorInfo == otherMessage.hasErrorInfo && (!self.hasErrorInfo || [self.errorInfo isEqual:otherMessage.errorInfo]) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
{
    if (resultRecentPushMsgsRsp.hasErrorInfo && resultRecentPushMsgsRsp.errorInfo != [ErrorInfo defaultInstance]) {
...
- (BOOL)isEqual:(id)other
{
    ...
    return self.hasUserId == otherMessage.hasUserId && (!self.hasUserId || self.userId == otherMessage.userId) && self.hasPlantformId == otherMessage.hasPlantformId && (!self.hasPlantformId || self.plantformId == otherMessage.plantformId) && self.hasPullStart == otherMessage.hasPullStart && (!self.hasPullStart || self.pullStart == otherMessage.pullStart) && self.hasPullCount == otherMessage.hasPullCount && (!self.hasPullCount || self.pullCount == otherMessage.pullCount) && (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
...
{
    if (resultGetOfflinePushMsgRsp.hasErrorInfo && resultGetOfflinePushMsgRsp.errorInfo != [ErrorInfo defaultInstance]) {
