...
{
    [self requestData];
    [_myTableView registerNib:[UINib nibWithNibName:@"GYAddreesCell" bundle:kDefaultBundle] forCellReuseIdentifier:@"addressCell"];
    [_myTableView registerNib:[UINib nibWithNibName:@"GYaddresRestaurantCell" bundle:kDefaultBundle] forCellReuseIdentifier:@"restaurantCell"];
    [_myTableView registerNib:[UINib nibWithNibName:@"GYOrderandStateCell" bundle:kDefaultBundle] forCellReuseIdentifier:@"JBCell"];
    [_myTableView registerNib:[UINib nibWithNibName:@"GYgreensCell" bundle:kDefaultBundle] forCellReuseIdentifier:@"orderID"];
    [_myTableView registerNib:[UINib nibWithNibName:@"GYdownpaymentCell" bundle:kDefaultBundle] forCellReuseIdentifier:@"downpay"];
    [_myTableView registerNib:[UINib nibWithNibName:@"GYMealTimeCell" bundle:kDefaultBundle] forCellReuseIdentifier:@"kGYMealTimeCell"];
    [_myTableView registerNib:[UINib nibWithNibName:@"GYNewMoneyCell" bundle:kDefaultBundle] forCellReuseIdentifier:@"kGYNewMoneyCell"];
}
