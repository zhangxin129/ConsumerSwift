...
- (void)setupTableView
{
    ...
    [_shopTableView registerNib:[UINib nibWithNibName:@"FDMainShopTableViewCell" bundle:nil] forCellReuseIdentifier:FDMainShopTableViewCellReuseId];
    [_shopTableView registerNib:[UINib nibWithNibName:@"FDMainShopCell" bundle:nil] forCellReuseIdentifier:FDMainShopCellId];
...
- (void)setupDropView
{
    ...
    [_tagTableView registerNib:[UINib nibWithNibName:@"FDMainDropCategoryTableViewCell" bundle:nil] forCellReuseIdentifier:FDMainDropCategoryTableViewCellReuseId];
    [_tagTableView registerNib:[UINib nibWithNibName:@"FDMainDropScoreTableViewCell" bundle:nil] forCellReuseIdentifier:FDMainDropScoreTableViewCellReuseId];
    [_tagTableView registerNib:[UINib nibWithNibName:@"FDMainDropServiceTableViewCell" bundle:nil] forCellReuseIdentifier:FDMainDropServiceTableViewCellReuseId];
    [_tagHalfTableViewLeft registerNib:[UINib nibWithNibName:@"FDDropAreaTableViewCell" bundle:nil] forCellReuseIdentifier:FDDropAreaTableViewCellReuseId];
    [_tagHalfTableViewRight registerNib:[UINib nibWithNibName:@"FDDropAreaTableViewCell" bundle:nil] forCellReuseIdentifier:FDDropAreaTableViewCellReuseId];
