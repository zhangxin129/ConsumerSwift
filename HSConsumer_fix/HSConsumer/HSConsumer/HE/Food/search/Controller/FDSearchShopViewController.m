...
- (void)viewDidLoad
{
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"FDTakeawayMainCell" bundle:nil] forCellReuseIdentifier:FDTakeawayCellReuseId];
    [_tableView registerNib:[UINib nibWithNibName:@"FDMainShopCell" bundle:nil] forCellReuseIdentifier:FDMainCellReuseId];
