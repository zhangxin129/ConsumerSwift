...
- (void)setupAvrageTableView
{
    ...
    for (int i = 0; i < _tableArray.count; i++) {
        ...
        [tableView registerNib:[UINib nibWithNibName:@"FDShopCommitCell" bundle:nil] forCellReuseIdentifier:FDShopCommitCellReuseId];
...
- (void)setTabelView
{
    ...
    [self.LeftTableView registerNib:[UINib nibWithNibName:@"FDCategoryTableViewCell" bundle:nil] forCellReuseIdentifier:FDCategoryTableViewCellReuseId];
    [self.rightTableView registerNib:[UINib nibWithNibName:@"FDChooseFoodTableViewCell" bundle:nil] forCellReuseIdentifier:FDChooseFoodTableViewCellReuseId];
    [self.rightTableView registerNib:[UINib nibWithNibName:@"FDChooseFoodTableViewCell" bundle:nil] forCellReuseIdentifier:FDChoosedFoodTableViewCellReuseId];
    [self.selectFoodTabelView registerNib:[UINib nibWithNibName:@"FDSelecteFoodCell" bundle:nil] forCellReuseIdentifier:FDSelectFoodTabelViewCellId];

    [self.foodDetailTabelView registerNib:[UINib nibWithNibName:@"foodDetailTopCell" bundle:nil] forCellReuseIdentifier:FoodDetailTopCellId];

    [self.foodDetailTabelView registerNib:[UINib nibWithNibName:@"FoodBasicInfoCell" bundle:nil] forCellReuseIdentifier:FoodBasicInfoCellId];
...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    if (tableView == self.LeftTableView) {
        ...
        if (cell == nil) {
            categoryCell = [[[NSBundle mainBundle] loadNibNamed:@"FDCategoryTableViewCell" owner:self options:nil] lastObject];
        }
        ...
        if (cell == nil) {
            foodCell = [[[NSBundle mainBundle] loadNibNamed:@"FDChooseFoodTableViewCell" owner:self options:nil] lastObject];
        }
        ...
        if (foodCell == nil) {
            foodCell = [[[NSBundle mainBundle] loadNibNamed:@"FDSelecteFoodCell" owner:self options:nil] lastObject];
        }
        ...
        if (indexPath.section == 0) {
            ...
            if (cell == nil) {
                cell = [[[NSBundle mainBundle] loadNibNamed:@"foodDetailTopCell" owner:self options:nil] lastObject];
            }
            ...
            if (cell == nil) {
                cell = [[[NSBundle mainBundle] loadNibNamed:@"FoodBasicInfoCell" owner:self options:nil] lastObject];
            }
        ...
        if (cell == nil) {
            cell = [[[NSBundle mainBundle] loadNibNamed:@"FDShopCommitCell" owner:self options:nil] lastObject];
        }
        ...
        if (tableView == _tasteTableView) {
            ...
            if (indexPath.section == 0) {
                ...
                if (cell == nil) {
                    cell = [[[NSBundle mainBundle] loadNibNamed:@"FDRecomdFoodDetailCell" owner:self options:nil] lastObject];
                }
                cell.selectionStyle = 0;
...
- (IBAction)orderAction:(id)sender
{
    ...
    if (_isTakeaway == YES) { //送外卖
        ...
        GYConfirmationViewController* orderVC = [[GYConfirmationViewController alloc] initWithNibName:@"GYConfirmationViewController" bundle:[NSBundle mainBundle]];
        orderVC.orderConfirModel = order;
        [self.navigationController pushViewController:orderVC animated:YES];
    }
}
