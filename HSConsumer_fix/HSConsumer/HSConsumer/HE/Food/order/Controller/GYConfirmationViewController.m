...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        GYOrderTableViewCell* cell = [GYOrderTableViewCell cellWithTableView:tableView andtitleName:kLocalized(@"GYHE_Food_OrderFoodAmount") andValue:[NSString stringWithFormat:@"%0.2f", [priceStr doubleValue]]];
        [cell setSelectionStyle:UITableViewCellSelectionStyleNone];
        return cell;
    }
