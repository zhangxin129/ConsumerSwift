...
- (void)viewDidLoad
{
    ...
    [self basicSettings];
    [self.tabView registerNib:[UINib nibWithNibName:@"GYHESCCartTableViewCell" bundle:nil] forCellReuseIdentifier:kShoppingCartCell];
}
...
//        self.dataSourceArray = [NSMutableArray arrayWithArray:array];
        ...
        [GYAlertView showMessage:kLocalized(@"HE_SC_CartDeleteSuccess") confirmBlock:^{
