...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"GYPaymentInfoTableViewCell" bundle:nil] forCellReuseIdentifier:infoTableViewCell];
    [self.tableView registerNib:[UINib nibWithNibName:@"GYPaymentListTableViewCell" bundle:nil] forCellReuseIdentifier:listTableViewCell];
    [self.tableView registerNib:[UINib nibWithNibName:@"GYPaymentPWDTableViewCell" bundle:nil] forCellReuseIdentifier:PWDTableViewCell];
