...
- (UICollectionView*)collectionView
{
    if (!_collectionView) {
        ...
        [self.collectionView registerNib:[UINib nibWithNibName:@"GYEasybuyHomeCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:GYEasybuyHomeCollectionViewCellReuseId];
    }
