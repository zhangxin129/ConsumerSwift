...
- (UICollectionView*)collectionView
{
    if (!_collectionView) {
        ...
        [self.collectionView registerNib:[UINib nibWithNibName:@"GYEasybuyTopicListCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:GYEasybuyTopicListCollectionViewCellReuseId];
    }
