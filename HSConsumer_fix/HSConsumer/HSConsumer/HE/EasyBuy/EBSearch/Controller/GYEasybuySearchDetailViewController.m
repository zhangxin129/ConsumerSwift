...
- (void)setUp
{
    ...
    [_tabView registerNib:[UINib nibWithNibName:@"GYEasybuySearchGoodsListCell" bundle:nil] forCellReuseIdentifier:kGYEasybuySearchGoodsListCell];
    [_tabView registerNib:[UINib nibWithNibName:@"GYEasybuySearchShopsListCell" bundle:nil] forCellReuseIdentifier:kGYEasybuySearchShopsListCell];
}
...
- (GYEasybuyOneDownView*)sortTypeTabView
{
    if (!_sortTypeTabView) {
        ...
        GYEasybuyServiceFooterView* footerView = [[NSBundle mainBundle] loadNibNamed:@"GYEasybuyServiceFooterView" owner:self options:0][0];
