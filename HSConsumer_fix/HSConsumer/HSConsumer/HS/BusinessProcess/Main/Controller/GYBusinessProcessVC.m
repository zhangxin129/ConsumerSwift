...
- (void)viewDidLoad
{
    ...
    [arrPowers addObject:@[
        @{ kKeyCellIcon : @"hs_cell_img_points_card_report_loss",
            ...
            kKeyNextVcName : NSStringFromClass([GYReportLossViewController class]) //挂失
        },
    ...
    [arrPowers addObject:@[ @{ kKeyCellIcon : @"hs_cell_img_medical",
        ...
        kKeyNextVcName : NSStringFromClass([GYHealthViewController class]) //医疗计划
    },
        ...
        @{ kKeyCellIcon : @"hs_cell_img_welfare",
            ...
            kKeyNextVcName : NSStringFromClass([GYWealCheckViewController class]) //积分福利查询
        } ]];
}
