...
@interface GYAccidtMedicalViewController () <UICollectionViewDelegate, UICollectionViewDataSource, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UITextFieldDelegate, GYGetPhotoViewDelegate,GYNetRequestDelegate> {
    GYBigPic* bigPic;
}
...
@implementation GYAccidtMedicalViewController
...
- (UICollectionView*)cvAccMedical
{
    if (_cvAccMedical == nil) {
        ...
        _cvAccMedical = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 16, kScreenWidth, kScreenHeight - 64) collectionViewLayout:flowLayout];
...
- (UICollectionViewCell*)collectionView:(UICollectionView*)collectionView cellForItemAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    NSArray* arr = @[ kSaftToNSString([man selectDecCode:@"1001"].fileId),
        kSaftToNSString([man selectDecCode:@"1002"].fileId),
        kSaftToNSString([man selectDecCode:@"1015"].fileId),
