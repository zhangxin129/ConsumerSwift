...
- (void)awakeFromNib {
    // Initialization code
    [self.textField setTextColor:kCellItemTitleColor];
    [self.LbLeftlabel setTextColor:kCellItemTitleColor];
    self.textField.delegate = self;
    [self.selectButton setImage:[UIImage imageNamed:@"hs_long_period_nomal"] forState:UIControlStateNormal];
    [self.selectButton setImage:[UIImage imageNamed:@"hs_long_period_selected"] forState:UIControlStateSelected];
