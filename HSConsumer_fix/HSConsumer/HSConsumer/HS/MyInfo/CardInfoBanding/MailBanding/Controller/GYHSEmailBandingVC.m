...
@interface GYHSEmailBandingVC () <UITableViewDelegate, UITableViewDataSource, GYHSRegisterTableCellDelegate, GYHSLoginVConfirmTableCellDelegate, GYNetRequestDelegate>
...
@end
@implementation GYHSEmailBandingVC
...
- (UITableView*)tableView
{
    if (_tableView == nil) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"GYHSRegisterTableCell" bundle:nil] forCellReuseIdentifier:kGYHSEmailBandingVC_CellIdentify];
        [_tableView registerNib:[UINib nibWithNibName:@"GYHSLoginVConfirmTableCell" bundle:nil] forCellReuseIdentifier:kGYHSEmailBandingVC_Cell_BtnIdentify];
    }
...
- (NSMutableArray*)dataArray
{
    if (_dataArray == nil) {
        ...
        [infoAry addObject:@{ @"Name" : kLocalized(@"GYHS_Banding_Email"),
            @"Value" : @"",
            @"placeHolder" : kLocalized(@"GYHS_Banding_Input_Binding_Email"),
        ...
        [infoAry addObject:@{ @"Name" : kLocalized(@"确认邮箱"),
            @"Value" : @"",
            @"placeHolder" : kLocalized(@"再次输入绑定的邮箱"),
            @"pwdType" : [NSNumber numberWithBool:NO],
            @"maxSize" : [NSNumber numberWithInt:100],
            @"keyBoardNum" : [NSNumber numberWithBool:NO]
        }];
        ...
        if (self.pageType == GYHSEmailBandingVCPageModify) {
            ...
            [_dataArray addObject:@[ @{ @"Name" : kLocalized(@"提示：系统将发送验证信息到您绑定的邮箱，请及时登录邮箱完成绑定。") } ]];
