...
- (void) parsequeryQuickBankList:(NSInteger)returnCode responseObject:(NSDictionary *)responseObject {
    ...
    if (self.dataArray.count > 0) {
        ...
        self.tipsView = [[[NSBundle mainBundle] loadNibNamed:@"GYHSNonQuickBankBindingView" owner:self options:nil] lastObject];
...
- (UITableView *) tableView {
    if (_tableView == nil) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"GYHSQuickPaymentCardTableCell" bundle:nil] forCellReuseIdentifier:kGYHSQuickPaymentCardVC_CellIdentify];
    }
