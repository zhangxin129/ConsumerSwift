...
- (UITableView*)tableView
{
    if (_tableView == nil) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"GYHSAddBankCardInfoTableViewCell" bundle:nil] forCellReuseIdentifier:GYHSAddBankCardInfo_Cell_Info_Identify];
        [_tableView registerNib:[UINib nibWithNibName:@"GYHSButtonCell" bundle:nil] forCellReuseIdentifier:GYHSAddBankCardInfo_Cell_Button_Identify];
    }
