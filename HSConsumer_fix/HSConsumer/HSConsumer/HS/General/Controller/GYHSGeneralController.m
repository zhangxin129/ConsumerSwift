...
- (void)viewDidLoad
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"GYHSGeneralCell" bundle:nil] forCellReuseIdentifier:@"GYHSGeneralCell"];
    [self.tableView registerNib:[UINib nibWithNibName:@"GYHSGeneralButtonCell" bundle:nil] forCellReuseIdentifier:@"GYHSGeneralButtonCell"];
