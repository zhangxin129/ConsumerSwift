...
- (void)viewDidLoad
{
    ...
    [self.investAccoutTableView registerNib:[UINib nibWithNibName:@"GYHSLabelTwoTableViewCell" bundle:nil] forCellReuseIdentifier:@"GYHSLabelTwoTableViewCell"];
    [self.investAccoutTableView registerNib:[UINib nibWithNibName:@"GYHSImageSixlabelCell" bundle:nil] forCellReuseIdentifier:@"GYHSImageSixlabelCell"];
    [self.investAccoutTableView registerNib:[UINib nibWithNibName:@"GYHSImageTowLabelCell" bundle:nil] forCellReuseIdentifier:@"GYHSImageTowLabelCell"];
    [self.investAccoutTableView registerNib:[UINib nibWithNibName:@"GYHSCellTypeImagelabel" bundle:nil] forCellReuseIdentifier:@"GYHSCellTypeImagelabel"];
