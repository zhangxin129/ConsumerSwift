...
@interface GYOtherPayStyleViewController () <UITableViewDataSource, UITableViewDelegate, PayEcoPpiDelegate, UPPayPluginDelegate, GYNetRequestDelegate> {
...
- (void)viewDidLoad
{
    ...
    [self.tabView registerNib:[UINib nibWithNibName:@"GYOtherPayStyleViewSpecialCell" bundle:nil] forCellReuseIdentifier:@"otherPayStyleViewSpecialCell"];
    [self.tabView registerNib:[UINib nibWithNibName:@"GYOtherPayStyleViewCell" bundle:nil] forCellReuseIdentifier:@"otherPayStyleViewCell"];
